...
- **StoryTag visualization** — ASCII overlays exist for corridors, yet there is no snapshot for swatches, paleo traces, or rainfall adjustments. Lightweight heatmaps (e.g., export arrays to disk when running headless) would help validate desert placement.
