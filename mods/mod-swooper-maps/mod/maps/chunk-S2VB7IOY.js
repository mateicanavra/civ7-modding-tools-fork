...
// ../../packages/mapgen-core/dist/chunk-WIG672NN.js
...
function runPlacement(adapter, iWidth, iHeight, options = {}) {
  ...
  try {
    if (starts?.westContinent && starts?.eastContinent) {
      ...
      const eastContinent = starts.eastContinent;
      const LANDMASS_REGION_WEST = typeof LandmassRegion !== "undefined" ? LandmassRegion.LANDMASS_REGION_WEST : 1;
      const LANDMASS_REGION_EAST = typeof LandmassRegion !== "undefined" ? LandmassRegion.LANDMASS_REGION_EAST : 2;
      const OCEAN_TERRAIN4 = 0;
      let westMarked = 0;
