...
import { LANDMASS_CFG, WORLDMODEL_OCEAN_SEPARATION, } from "../bootstrap/tunables.js";
 ...
 */
export function createDiverseLandmasses(iWidth, iHeight, landmasses, ctx) {
    ...
    for (let iY = 0; iY < iHeight; iY++) {
        for (let iX = 0; iX < iWidth; iX++) {
            ...
            // Use adapter if context provided, otherwise fall back to direct engine call
            if (ctx && ctx.adapter) {
                ctx.adapter.setTerrainType(iX, iY, terrain);
            } else {
