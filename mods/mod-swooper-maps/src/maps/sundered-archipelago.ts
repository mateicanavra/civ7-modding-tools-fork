  ...
  return {
      ...
      biomes: {
        ...
        vegetation: {
          ...
          moistureWeight: 0.55,
          humidityWeight: 0.25,
          moistureNormalizationPadding: 35,
          biomeModifiers: {
            ...
            tropicalRainforest: { multiplier: 1.1, bonus: 0.3 },
      ...
      featuresDensity: {
        ...
        shelfReefRadius: 2,
        rainforestVegetationScale: 70,
        forestVegetationScale: 45,
        taigaVegetationScale: 15,
        rainforestMinRainfall: 120,
      ...
      featuresPlacement: {
        ...
        config: {
          ...
          vegetated: {
            ...
            tundraTaigaMinVegetation: 0.2,
            tundraTaigaMinTemperature: -2,
            temperateDryForestMoisture: 110,
