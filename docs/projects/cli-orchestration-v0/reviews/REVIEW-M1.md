...
**Update:** 2025-12-21
- Added milestone doc discovery + project-scoped issue filtering; `milestoneDocPath` now resolves from `docs/projects/<project>/milestones/...`.
- Documented manual invocation + sync prerequisites in `scripts/cli-orchestration/README.md`.
...
**Update:** 2025-12-21
- Added repo-local prompt sources under `plugins/dev/commands/` and `plugins/dev/skills/autonomous-development/`.
- Added contract references to prompt headers and documented sync flow in the contract/README.
