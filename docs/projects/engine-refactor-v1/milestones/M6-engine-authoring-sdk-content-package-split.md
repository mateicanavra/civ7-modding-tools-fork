...
**Children**
- [x] [LOCAL-TBD-M6-U04-1](../issues/LOCAL-TBD-M6-U04-1-relocate-domain-modules-to-mod-owned-libs.md) — Done (branch: `m6-u04-1-relocate-domain-modules-to-mod-owned-libs`; review: `m6-u04-1-review-relocate-domain-modules-to-mod-owned-libs`; PR: pending)
