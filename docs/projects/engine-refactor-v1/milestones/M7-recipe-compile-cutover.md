...
| A2 | compileRecipeConfig end-to-end wiring | [A1] | [LOCAL-TBD-M7-A2](../issues/LOCAL-TBD-M7-A2-compile-recipe-config-wiring.md) | [x] | branch `m7-t02-compile-recipe-config-wiring` (PR: https://app.graphite.dev/submit/mateicanavra/civ7-modding-tools-fork/396) |
