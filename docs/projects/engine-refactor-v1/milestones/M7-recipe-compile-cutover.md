...
| B4 | Op normalization hook semantics: resolveConfig -> normalize | [] | [LOCAL-TBD-M7-B4](../issues/LOCAL-TBD-M7-B4-op-normalize-semantics.md) | [x] | branch `m7-t06-op-normalize-semantics` (PR: https://app.graphite.dev/submit/mateicanavra/civ7-modding-tools-fork/400) |
