...
| B1 | Step id convention: kebab-case enforced | [] | [LOCAL-TBD-M7-B1](../issues/LOCAL-TBD-M7-B1-step-id-kebab-case.md) | [x] | branch `m7-t03-step-id-kebab-case` (PR: https://app.graphite.dev/submit/mateicanavra/civ7-modding-tools-fork/397) |
