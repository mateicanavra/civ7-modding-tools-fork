...
| B3 | Domain ops registries + binding helpers | [] | [LOCAL-TBD-M7-B3](../issues/LOCAL-TBD-M7-B3-domain-ops-registries.md) | [x] | branch `m7-t05-domain-ops-registries` (PR: https://app.graphite.dev/submit/mateicanavra/civ7-modding-tools-fork/399) |
