...
- [x] [M5-U04](../issues/M5-U04-extract-standard-foundation-physics.md) — extract foundation & physics steps + helpers into the base mod (branch: `m5-u04-extract-standard-foundation-physics`)
