...
- [x] [M5-U10](../issues/M5-U10-colocation-consolidation-pass.md) — colocation + consolidation pass (reduce wiring-only indirection) (branch: `m5-u10-colocation-consolidation-pass`)
