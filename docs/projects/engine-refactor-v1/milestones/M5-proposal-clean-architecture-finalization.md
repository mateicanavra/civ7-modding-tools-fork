...
- [x] [M5-U07](../issues/M5-U07-delete-compat-deprecation-surfaces.md) — delete dead/compat/deprecation-only surfaces (“no dead code” true) (branch: `m5-u07-delete-compat-deprecation-surfaces`)
