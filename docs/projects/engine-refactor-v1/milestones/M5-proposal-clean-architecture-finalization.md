...
- [x] [M5-U01](../issues/M5-U01-DEF-011-delete-crust-mode.md) — DEF‑011: delete `crustMode` and the `"legacy"` behavior branch (branch: `m5-u01-def-011-delete-crust-mode`, fix: `m5-fix-u01-stage-results`, fix PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools-fork/262)
...
- [x] [M5-U08](../issues/M5-U08-remove-globals-fallbacks-engine-boundary.md) — remove ambient globals + silent fallbacks (boring engine boundary) (branch: `m5-u08-remove-globals-fallbacks-engine-boundary`, review: `m5-u08-review-remove-globals-fallbacks-engine-boundary`, PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools-fork/250, fix: `m5-fix-u08-voronoi-guard`, fix PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools-fork/263)
...
- [x] [M5-U11](../issues/M5-U11-DEF-014-foundation-inventory.md) — DEF‑014: foundation artifact inventory + consumer migration (branch: `m5-u11-def-014-foundation-inventory`, review: `m5-u11-review-def-014-foundation-inventory`, PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools-fork/253, fix: `m5-fix-u11-foundation-contract`, fix PR: https://app.graphite.com/github/pr/mateicanavra/civ7-modding-tools-fork/264)
