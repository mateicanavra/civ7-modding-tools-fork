...
**Status (2025-12-23):**
- Effect tags for biomes/features/placement are registered with adapter-backed verification hooks (call-evidence only); migration to `effect:*` scheduling is still pending.
