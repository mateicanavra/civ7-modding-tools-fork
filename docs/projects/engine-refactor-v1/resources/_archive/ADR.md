<!-- DocId: ER1-ADR-REGISTER-ARCHIVE -->

# Engine Refactor v1 — Architecture Decision Record (Historical Register)

> This file is a **historical compiled decision register** for Engine Refactor v1.
>
> It summarizes decisions that were accepted at the time it was written.
>
> It does **not** introduce new decisions, and should not be used as a current source of truth.
