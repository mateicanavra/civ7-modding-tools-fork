...
- **Compat invariant:** shims/compat are forbidden as a refactor technique (inside or outside the domain). Migrate consumers and delete in-slice (pipeline-green, no dual paths).
