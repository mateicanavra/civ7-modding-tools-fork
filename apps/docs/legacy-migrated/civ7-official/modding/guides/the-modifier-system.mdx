...
> **Note:** 
> This article assumes familiarity with the basics of [Database Modding](/migrated/civ7-official/modding/guides/database-modding). Familiarise yourself with that before diving into Modifiers!
