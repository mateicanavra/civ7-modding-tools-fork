---
title: What is Database Modding?
---
...
1. Make new mod with a `.modinfo` file if you don't have one already (see the [Getting Started](/migrated/civ7-official/modding/guides/getting-started) page if you're not sure how).
...
![](/migrated/civ7-official/modding/guides/images/NewPolicies_1.png)
...
Unfortunately no. For that we'll need Modifiers, which is *technically* just making more Gameplay Database changes, but Modifiers are also a system unto itself. Check out the [Modifier System](/migrated/civ7-official/modding/guides/the-modifier-system) article for more information.
...
![](/migrated/civ7-official/modding/guides/images/NewPolicies_2.png)
...
![](/migrated/civ7-official/modding/guides/images/ConfigFolder.png)
...
The simplest way is probably browsing the game files. If you installed the game via Steam, you can find where the game is installed via the game's properties (as detailed in the [Getting Started](/migrated/civ7-official/modding/guides/getting-started) document).
...
![](/migrated/civ7-official/modding/guides/images/game-files-modules.png)

![](/migrated/civ7-official/modding/guides/images/game-files-data.png)
...
![](/migrated/civ7-official/modding/guides/images/SearchingGameFiles.png)

----

Alternatively, you can also use a **SQLite Database Browser** to view game data.

If you have `CopyDatabasesToDisk` set to 1 (as detailed in the [Getting Started](/migrated/civ7-official/modding/guides/getting-started) document), the game will output `.sqlite` files in the `debug` folder after you have started a game.

![](/migrated/civ7-official/modding/guides/images/gameplay-copy.png)
...
![](/migrated/civ7-official/modding/guides/images/sqlite-browse.png)

## Debugging errors

If there is an error in your code, you will usually be greeted with this warning when you try to start a game.

![](/migrated/civ7-official/modding/guides/images/content-validation-failed.png)
...
![](/migrated/civ7-official/modding/guides/images/logs-folder.png)
...
![](/migrated/civ7-official/modding/guides/images/database-log.png)
...
![](/migrated/civ7-official/modding/guides/images/sql-error.png)