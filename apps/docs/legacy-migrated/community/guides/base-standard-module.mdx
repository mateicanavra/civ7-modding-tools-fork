...
- For core architecture concepts, see [Civ7 Modding Architecture](/migrated/community/guides/guides/modding-architecture)
- For database schema details, see [Database Schemas](/migrated/community/guides/guides/database-schemas)
- For Age module specifics, see [Age Modules](/migrated/community/guides/guides/age-modules)
- For real-world examples, see [DLC and Community Mod Patterns](/migrated/community/guides/guides/mod-patterns)
