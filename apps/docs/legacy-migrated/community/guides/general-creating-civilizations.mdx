...
2. Familiarity with the game's database schema (see [Database Schemas](/migrated/community/guides/guides/database-schemas))
...
- [Age Modules](/migrated/community/guides/guides/age-modules)
