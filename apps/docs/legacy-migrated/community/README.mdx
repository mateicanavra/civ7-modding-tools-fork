---
title: Civilization VII Modding Documentation
---
...
New to Civilization VII modding? Start with our [Getting Started Guide](/migrated/community/guides/getting-started) to learn the basics and set up your environment. Then explore the various sections to dive deeper into specific aspects of modding.

For a comprehensive overview of all documentation with contextual descriptions and recommended learning paths, check out our [Documentation Guide](/migrated/community/documentation-guide).
...
- **Learning Paths**: Recommended document sequences for different skill levels in the [Documentation Guide](/migrated/community/documentation-guide)
