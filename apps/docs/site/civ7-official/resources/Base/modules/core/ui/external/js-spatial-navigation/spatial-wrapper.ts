...
import SpatialNavigation, { NavigationDirection } from '/core/ui/external/js-spatial-navigation/spatial_navigation.js';
import FocusManager from '/core/ui/input/focus-manager.js';

class SpatialWrapper {
	private static _Instance: SpatialWrapper;
	...
	navigate(sectionId: string, focusableChildren: Array<Element>, direction: string): boolean {
		...
		SpatialNavigation.move(direction as NavigationDirection);
