...
class ProgressionPortrait extends Component {
    constructor() {
        super(...arguments);
        this.portraitLevel = "base";
        this.legendPath = "LEADER";
        this.leaderLevel = "1";
        this.borderURL = "";
        this.displayLevel = Network.supportsSSO();
    }
    onAttach() {
        super.onAttach();
    }
...
//# sourceMappingURL=file:///core/ui/progression-portrait/progression-portrait.js.map
