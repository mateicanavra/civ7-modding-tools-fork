...
export const ChooserItemSelectedEventName = 'chooser-item-selected';
/**
 * Dispatched when a chooser item is selected
 *
 * Default behavior is to set the selected attribute of the chooser item to true
 */
export class ChooserItemSelectedEvent extends CustomEvent {
    constructor() {
...
export class FxsChooserItem extends FxsActivatable {
    ...
    constructor(root) {
        ...
        this.iconLockToggleFuncs = new Map();
...
//# sourceMappingURL=file:///core/ui/components/fxs-chooser-item.js.map
