...
export class ScreenDialogBox extends Panel {
    constructor(root) {
        ...
        this.closeButtonListener = () => { this.requestClose(); };
        this.engineInputListener = this.onEngineInput.bind(this);
        this.navigateInputListener = this.onNavigateInput.bind(this);
        this.valueChangeListener = this.onValueChange.bind(this);
        this.textboxKeyupListener = this.onTextboxKeyup.bind(this);
        this.textBoxTextEditStopListener = this.onTextboxEditStop.bind(this);
        this.closing = false;
        this.options = [];
        this.customOptions = [];
    ...
    onValueChange({ detail: { value }, target }) {
        this.options.forEach(({ valueChangeCallback, label }) => {
            if (valueChangeCallback) {
                valueChangeCallback(target.id, value, this.buttonContainer?.querySelector(`fxs-button[caption='${label}']`) || undefined);
            }
        });
    }
...
//# sourceMappingURL=file:///core/ui/dialog-box/screen-dialog-box.js.map
