...
type CheckboxValueChangeEventDetail = { value: boolean, forced: boolean };
export type CheckboxValueChangeEvent = ComponentValueChangeEvent<CheckboxValueChangeEventDetail>;
export class FxsCheckbox extends ChangeNotificationComponent<CheckboxValueChangeEventDetail> {
	private navHelp?: HTMLElement;
	private readonly navContainer = document.createElement('div');
	private readonly idleElement = document.createElement('div');
	private readonly highlightElement = document.createElement('div');
	private readonly pressedElement = document.createElement('div');
	...
	toggle(force: boolean | undefined = undefined): void {
		...
		const changeEvent: CheckboxValueChangeEvent = new ComponentValueChangeEvent({ value: this.isChecked, forced: force != undefined });
