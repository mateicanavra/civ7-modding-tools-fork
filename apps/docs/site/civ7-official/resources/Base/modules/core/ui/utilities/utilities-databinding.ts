 ...
 * @param verbose 
 */
export function databindComponentID(target: HTMLElement, baseComponentID: string, verbose?: boolean) {
 ...
 */
export function databindRetrieveComponentID(target: HTMLElement): ComponentID {
 ...
 */
export function databindRetrieveComponentIDSerial(target: HTMLElement): string {
	const foundID = target.getAttribute('componentid');
	return foundID ?? "";
}
