...
export class EditableHeaderTextChangedEvent extends CustomEvent {
    constructor(newStr) {
...
export class FxsEditableHeader extends FxsHeader {
    constructor() {
        ...
        this.editableTextBox = document.createElement("fxs-textbox");
        this.staticText = document.createElement("div");
        this.textEditToggleButton = document.createElement("fxs-edit-button");
        this.textEditToggleNavHelp = document.createElement("fxs-nav-help");
        this.disable = false;
        this.onEditToggleActivatedListener = this.onEditToggleActivated.bind(this);
        this.onTextEditStoppedListener = this.onTextEditStopped.bind(this);
...
//# sourceMappingURL=file:///core/ui/components/fxs-editable-header.js.map
