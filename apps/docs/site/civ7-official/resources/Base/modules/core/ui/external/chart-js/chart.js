...
(function (global, factory) {
  ...
  // BEGIN FIRAXIS CHANGE - Alter/polyfill CanvasRenderingContext2D
  
  // As of 1.31.0.1 resetTransform is not implemented.  Replace with a functional polyfill.
  ...
  // As of 1.31.0.1 clip() does nothing but assert.  Replace it with a noop to avoid the asserts.
  CanvasRenderingContext2D.prototype.clip = function () {}

  // As of Coherent 1.31.0.1 setLineDash is not implemented.  replace with a noop.
  if (typeof CanvasRenderingContext2D.prototype.setLineDash !== 'function') {
    CanvasRenderingContext2D.prototype.setLineDash = function () {};
  }

  // fillText currently does not support maxWidth
  const fillTextImplementation = CanvasRenderingContext2D.prototype.fillText
  CanvasRenderingContext2D.prototype.fillText = function (text, x, y, maxWidth) {
    fillTextImplementation.call(this, text, x, y);
  }
  // END FIRAXIS CHANGE
  ...
  function _descriptors(proxy, defaults = {
    ...
    const {
      _scriptable = defaults.scriptable, _indexable = defaults.indexable, _allKeys = defaults.allKeys
    } = proxy;
    return {
      allKeys: _allKeys,
  ...
  function formatNumber(num, locale, options) {
    // BEGIN FIRAXIS CHANGE
    return Locale.toNumber(num);
  ...
  function createResizeObserver(chart, type, listener) {
    // FIRAXIS CHANGE - As of Coherent Gameface 1.31.0.1 'ResizeObserver' is not implemented.
    // Early out if ResizeObserver does not exist.
