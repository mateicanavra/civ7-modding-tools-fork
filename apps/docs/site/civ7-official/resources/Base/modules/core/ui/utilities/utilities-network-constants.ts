...
export const abandonStrToErrorBody = new Map<KickReason, string>([
...
export const abandonStrToErrorTitle = new Map<KickReason, string>([
...
export const gameListUpdateTypeToErrorBody = new Map<GameListUpdateType, string>([
	[GameListUpdateType.GAMELISTUPDATE_ERROR, "LOC_GAME_LIST_ERROR_GENERAL"],
])

export const lobbyErrorTypeToErrorBody = new Map<LobbyErrorType, string>([
...
export const joinGameErrorTypeToErrorBody = new Map<JoinGameErrorType, string>([
...
export const serverTypeToGameModeType = new Map<ServerType, GameModeTypes>([
...
export const multiplayerTeamColors: string[] = [
	"#000000",
