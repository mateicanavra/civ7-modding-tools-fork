...
class AgeSelectPanel extends GameCreationPanelBase {
    constructor(root) {
        super(root);
        this.ageButtonListener = this.handleSelectAge.bind(this);
        this.ageFocusListener = this.handleFocusAge.bind(this);
        this.ageButtons = [];
        this.selectedAgeButton = null;
        this.agesSlot = null;
        this.agesScrollable = null;
...
//# sourceMappingURL=file:///core/ui/shell/create-panels/age-select-panel.js.map
