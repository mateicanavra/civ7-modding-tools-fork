...
class PanelDownloadAssets extends Panel {
    constructor(root) {
        super(root);
        this.progressData = 0;
        this.ODRDownloadProgressListener = this.onODRDownloadProgress.bind(this);
        this.ODRDownloadFinishedListener = this.onODRDownloadFinished.bind(this);
...
//# sourceMappingURL=file:///core/ui/shell/odr-download/odr-download.js.map
