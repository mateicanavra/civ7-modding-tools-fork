...
export class FxsHoldToConfirm extends Component {
	private readonly DEFAULT_HOLD_SECS = 3;

	private ringElement?: ComponentRoot<FxsRingMeter>;
	private iconElement?: HTMLDivElement;
	private labelElement?: HTMLDivElement;

	private engineInputEventListener: EventListener = this.onEngineInput.bind(this);
	private updateIconEventListener: EventListener = this.updateIcon.bind(this);
	...
	public get actionKey(): string | null {
