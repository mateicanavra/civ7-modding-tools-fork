...
class TestCivicsCard extends Component {
    ...
    onAttach() {
        ...
        const tierHighlight = document.createElement('div');
        ...
        const mainCardHitbox = document.createElement('div');
        ...
        const iconBigShadow = document.createElement('div');
        ...
        const progressShadow = document.createElement('div');
        ...
        const iconHighlight = document.createElement('div');
        ...
        const mainHighlight = document.createElement('div');
        ...
        const cardBGThinFrame = document.createElement('div');
        cardBGThinFrame.classList.add('test-civics-card__thin-frame');
        mainCard.appendChild(cardBGThinFrame);
        const cardBGGradient = document.createElement('div');
        ...
        const cardBGThickFrame = document.createElement('div');
        ...
        const cardBonuses = document.createElement('div');
        cardBonuses.classList.add('test-civics-card__bonus-container');
        // Main Bonuses
        const mainBonusLeftPattern = document.createElement("div");
        {
        ...
        const mainBonusCount = parseInt(this.Root.getAttribute('data-main-bonus-count') ?? "0");
        for (let i = 0; i < mainBonusCount; i++) {
            const bonus = document.createElement('test-hex-icon');
            bonus.classList.add('test-civics-card__bonus');
            cardBonuses.appendChild(bonus);
        }
        const mainBonusRightPattern = document.createElement("div");
        {
        ...
        const cardBGLightGradient = document.createElement('div');
        ...
        const cardBGDarkGradient = document.createElement('div');
        ...
        const iconTurnCounter = document.createElement('test-turn-counter');
        ...
        const primaryColor = this.Root.getAttribute('data-primary-color');
        const secondaryColor = this.Root.getAttribute('data-secondary-color');
        if (primaryColor && secondaryColor) {
            this.realizePlayerColors(this.Root, primaryColor, secondaryColor);
        }
        // Apply relevant classes (only for this sandbox example)
        const mainCardStatus = this.Root.getAttribute('data-main-card');
        ...
        const secondTierStatus = this.Root.getAttribute('data-second-tier');
        if (secondTierStatus) {
            const bonusCount = parseInt(this.Root.getAttribute('data-second-tier-bonus-count') ?? "0");
            const tier2 = this.createTierCard("III", bonusCount);
        ...
        const firstTierStatus = this.Root.getAttribute('data-first-tier');
        if (firstTierStatus) {
            const bonusCount = parseInt(this.Root.getAttribute('data-first-tier-bonus-count') ?? "0");
            const tier1 = this.createTierCard("II", bonusCount);
    ...
    createTierCard(iconText, bonusCount) {
        const tier = document.createElement('div');
        {
            ...
            const tierRightPattern = document.createElement("div");
            {
            ...
            const tierLightGradient = document.createElement('div');
            ...
            const tierDarkGradient = document.createElement('div');
            ...
            iconContainer.appendChild(iconFrame);
            const iconInnerBG = document.createElement('div');
    ...
    realizePlayerColors(target, playerColorPri, playerColorSec) {
        // set colors based on the player's colors
        const playerColorVariants = PlayerColors.createPlayerColorVariants(playerColorPri, playerColorSec);
...
class TestTurnCounter extends Component {
    ...
    onAttach() {
        super.onAttach();
        // Shadow
        const turnCounterShadow = document.createElement('div');
        turnCounterShadow.classList.add('test-turn-counter__shadow');
        this.Root.appendChild(turnCounterShadow);
        // Outer border
        const turnCounterOuterBG = document.createElement('div');
        ...
        // Inner shape
        const turnCounterFrame = document.createElement('div');
        ...
        // Icon
        const turnCounterNumber = document.createElement("div");
        ...
        // Overlay
        const turnCounterOverlay = document.createElement('div');
...
//# sourceMappingURL=file:///core/ui/sandbox/components/test_components.js.map
