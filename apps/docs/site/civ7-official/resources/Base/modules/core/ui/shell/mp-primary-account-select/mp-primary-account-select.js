...
class MpPrimaryAccountSelect extends Panel {
    constructor() {
        ...
        this.currentPrimaryProfile = null;
        this.currentPlatformProfile = null;
        this.engineInputListener = (inputEvent) => { this.onEngineInput(inputEvent); };
        this.profileButtonListener = (useCurrentPrimary) => { this.onUserProfileSelected(useCurrentPrimary); };
    ...
    onAttach() {
        ...
        const currentPrimaryAccountButton = MustGetElement('.mp-primary-account-select__primary-account-info', this.Root);
        ...
        const currentPlatformAccountButton = MustGetElement('.mp-primary-account-select__platform-account-info', this.Root);
    ...
    buildPlayerCard(isPlatformProfile = false) {
        ...
        const playerTitle = Locale.compose(isPlatformProfile ? this.currentPlatformProfile?.TitleLocKey ?? "" : this.currentPrimaryProfile?.TitleLocKey ?? "");
...
//# sourceMappingURL=file:///core/ui/shell/mp-primary-account-select/mp-primary-account-select.js.map
