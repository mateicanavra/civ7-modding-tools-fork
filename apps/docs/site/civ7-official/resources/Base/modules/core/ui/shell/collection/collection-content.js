...
export class CollectionContent extends Panel {
    constructor(root) {
        super(root);
        this.promosRetrievalCompleteListener = (data) => { this.createCards(data); };
        this.focusListener = this.onFocus.bind(this);
        this.engineInputListener = this.onEngineInput.bind(this);
        this.selectedCard = null;
        this.pendingContentSelection = null;
        // Leader or civilizaiton type -> card + item
        this.contentToCardLookup = new Map();
    }
    ;
    onInitialize() {
    ...
    createItemCard(item, targetElement) {
        ...
        hoverOverlay.classList.add('img-list-focus-frame_highlight', "w-full", "h-full", "absolute", "pointer-events-auto", 'opacity-0', "group-hover\\:opacity-100", "group-focus\\:opacity-100");
...
//# sourceMappingURL=file:///core/ui/shell/collection/collection-content.js.map
