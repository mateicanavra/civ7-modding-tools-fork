...
export class GameCreationPanelBase extends Panel {
    constructor(root) {
        ...
        this.randomLeaderContent = null;
        this.bottomBarEle = null;
        this.confirmButton = document.createElement("fxs-hero-button");
        this.leaderBox = null;
        this.leaderBoxLeader = null;
        this.leaderBoxLeaderToAge = null;
        this.leaderBoxAge = null;
        this.leaderBoxLeaderToCiv = null;
        this.leaderBoxCiv = null;
        this.quoteSubtitles = null;
...
//# sourceMappingURL=file:///core/ui/shell/create-panels/game-creation-panel-base.js.map
