 ...
 */
export async function waitForElementStyle(element, property, target) {
    ...
    let promise = new Promise((res) => {
        ...
        let checkReadyStatus = () => {
            ...
            requestAnimationFrame(() => {
                ...
                let _value = parseFloat(window.getComputedStyle(element).getPropertyValue(property));
...
//# sourceMappingURL=file:///core/ui/utilities/utilities-core-stylechecker.js.map
