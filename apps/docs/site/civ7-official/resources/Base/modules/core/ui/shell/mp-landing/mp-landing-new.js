...
class PanelMPLanding extends Panel {
    constructor(root) {
        ...
        this.localButtonListener = this.onLocal.bind(this);
        this.wLanButtonListener = this.onWLan.bind(this);
        this.internetButtonListener = this.onInternet.bind(this);
...
//# sourceMappingURL=file:///core/ui/shell/mp-landing/mp-landing-new.js.map
