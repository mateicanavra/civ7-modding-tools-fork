...
class FxsMovie extends FxsActivatable {
    constructor(root) {
        super(root);
        this.readyStateListener = this.onCheckReadyState.bind(this);
        this.movieSkipListener = this.onSkipMovie.bind(this, false);
        this.moviePlayingListener = this.onMoviePlaying.bind(this);
        this.movieEndedListener = this.onMovieEnded.bind(this);
        this.playbackStalledListener = this.onPlaybackStalled.bind(this);
        this.playbackResumedListener = this.onPlaybackResumed.bind(this);
        this.movieErrorListener = this.onMovieError.bind(this);
    ...
    addSubtitleElement(text, duration) {
...
//# sourceMappingURL=file:///core/ui/components/fxs-movie.js.map
