...
export class FxsTabBar extends Component {
    constructor() {
        ...
        this.selectionIndicatorPositionValue = CSS.percent(0);
        this.navHelpLeftElement = document.createElement('fxs-nav-help');
        this.navHelpRightElement = document.createElement('fxs-nav-help');
        this.tabItems = [];
        this.tabElements = [];
        ...
        this.resizeObserver = new ResizeObserver(this.doSelectorPositionUpdate.bind(this));
        this.handleResizeEventListener = this.doSelectorPositionUpdate.bind(this);
...
//# sourceMappingURL=file:///core/ui/components/fxs-tab-bar.js.map
