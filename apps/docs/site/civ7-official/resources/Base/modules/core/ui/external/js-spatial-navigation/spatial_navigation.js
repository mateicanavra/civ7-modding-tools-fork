...
//    'use strict';
  ...
  function getSectionId(elem) {
    ...
    do {
      var parentSectionId = parent.getAttribute('sectionId');
      parent = parent.parentElement;
    } while (!parentSectionId && parent != document);
  ...
  function getSectionNavigableElements(sectionId) {
    ...
    for (const [key, elem] of Object.entries(_sections[sectionId])) {
      if (elem instanceof HTMLElement && isNavigable(elem, sectionId)) {
        navigableElements.push(elem);
      }
    }
  ...
  export { SpatialNavigation as default };
