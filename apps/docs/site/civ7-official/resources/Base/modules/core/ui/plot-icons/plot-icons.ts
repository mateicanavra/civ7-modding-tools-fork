...
export enum IconAnimationState {
	NONE,
	FIRST,
	FADE
}
...
class PlotIcons extends Component {
	...
	private worldAnchorHandle: number | null = null;
	...
	onAttach() {
		...
		const revealedState: RevealedStates = GameplayMap.getRevealedState(GameContext.localPlayerID, this.location.x, this.location.y);
	...
	setVisibility(revealedState: RevealedStates) {
