...
(function (FocusState) {
    ...
    FocusState["CHAT"] = "CHAT";
    FocusState["CHAT_DIALOG"] = "CHAT_DIALOG";
})(FocusState || (FocusState = {}));
class PanelMPLobby extends Panel {
    constructor(root) {
        super(root);
        this.kickHeader = MustGetElement(".mp-staging__kick-header", this.Root);
        this.joinCodeShown = false;
        this.focusState = FocusState.PLAYER_SLOT;
        this.mementosButtonActivateListener = this.onMementosButtonActivate.bind(this);
        this.resizeListener = this.onResize.bind(this);
        this.toggleChatActivateListener = this.onToggleChatActivate.bind(this);
        this.lobbyUpdateListener = this.onLobbyUpdate.bind(this);
        this.chatFocusListener = this.onChatFocus.bind(this);
        this.chatEngineInputListener = this.onChatEngineInput.bind(this);
        this.profileAccountLoggedOutListener = this.onProfileAccountLoggedOut.bind(this);
        this.activeDeviceTypeChangeListener = this.onActiveDeviceTypeChange.bind(this);
        this.readyIndicatorActivateListener = this.onReadyIndicatorActivate.bind(this);
...
class PanelMPChat extends Panel {
    constructor(root) {
        super(root);
        this.closeButtonActivateListener = this.onCloseButtonActivate.bind(this);
...
//# sourceMappingURL=file:///core/ui/shell/mp-staging/mp-staging-new.js.map
