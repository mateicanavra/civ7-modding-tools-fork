...
TutorialManager.add({
    ...
    quest: {
        ...
        getDescriptionLocParams: () => {
            ...
            let academyComplete = "[icon:QUEST_ITEM_OPEN]";
            const player = Players.get(GameContext.localPlayerID);
            if (player) {
                let playerTechs = player.Techs;
...
TutorialManager.add({
    ...
    quest: {
        ...
        getDescriptionLocParams: () => {
            ...
            let armyCompleteIcon = "[icon:QUEST_ITEM_OPEN]";
            const player = Players.get(GameContext.localPlayerID);
            if (player && player.Units) {
    ...
    onCompleteCheck: (_item) => {
        ...
        if (player) {
            ...
            if (TutorialManager.activatingEventName == "UnitAddedToMap") {
                let activationEventData = TutorialManager.activatingEvent;
...
TutorialManager.add({
    ...
    quest: {
        ...
        getDescriptionLocParams: () => {
            ...
            if (player) {
                if (merchantDef) {
                    let buildMerchantType = player?.Units?.getBuildUnit(merchantDef.UnitType);
...
//# sourceMappingURL=file:///age-antiquity/ui/tutorial/tutorial-quest-items-antiquity.js.map
