...
interface ReBaseInterfaceModeContext extends InterfaceMode.Context {
	UnitID: ComponentID;
...
/**
 * Handler for INTERFACEMODE_REBASE.
 */
class ReBaseInterfaceMode extends ChoosePlotInterfaceMode {
	...
	initialize() {
		const context = this.Context as ReBaseInterfaceModeContext;
		const args: any = {};
