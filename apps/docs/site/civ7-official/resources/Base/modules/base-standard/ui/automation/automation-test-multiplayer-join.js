...
class AutomationTestPlayGame extends AutomationBasePlayGame {
    constructor() {
        super(...arguments);
        this.automationTestMultiplayerJoinListener = (command, ...args) => { this.onAutomationEvent(command, args); };
        this.mpGameListUpdatedListener = (data) => { this.onMultiplayerGameListUpdated(data); };
        this.mpGameListCompleteListener = (data) => { this.onMultiplayerGameListComplete(data); };
        this.joinGameName = "";
    }
    register() {
    ...
    onAutomationEvent(command, ...args) {
        ...
        if (command === 'Run') {
            ...
            if (joinCodeParam !== null) {
                ...
                const joinServerType = Automation.getParameter("CurrentTest", "ServerType", ServerType.SERVER_TYPE_INTERNET);
            ...
            if (gameNameParam != null) {
                ...
                const browseServerType = Automation.getParameter("CurrentTest", "ServerType", ServerType.SERVER_TYPE_INTERNET);
    ...
    onMultiplayerGameListUpdated(data) {
        ...
        let gameListData = Network.getGameListEntry(data.idLobby);
...
//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-multiplayer-join.js.map
