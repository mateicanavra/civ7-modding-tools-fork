...
export var TreeCardStates;
(function (TreeCardStates) {
    TreeCardStates[TreeCardStates["COMPLETE"] = 0] = "COMPLETE";
    TreeCardStates[TreeCardStates["RESEARCHING"] = 1] = "RESEARCHING";
    TreeCardStates[TreeCardStates["AVAILABLE"] = 2] = "AVAILABLE";
    TreeCardStates[TreeCardStates["LOCKED"] = 3] = "LOCKED";
})(TreeCardStates || (TreeCardStates = {}));
export const TreeCardHoveredEventName = 'tree-card-hovered';
export class TreeCardHoveredEvent extends CustomEvent {
    constructor(detail) {
        super(TreeCardHoveredEventName, { bubbles: false, cancelable: true, detail });
    }
}
export const TreeCardDehoveredEventName = 'tree-card-dehovered';
export class TreeCardDehoveredEvent extends CustomEvent {
    constructor(detail) {
        super(TreeCardDehoveredEventName, { bubbles: false, cancelable: true, detail });
    }
}
export const TreeCardActivatedEventName = 'tree-card-activated';
export class TreeCardActivatedEvent extends CustomEvent {
    constructor(detail) {
...
class TreeCard extends TreeCardBase {
    constructor() {
        ...
        this.mainCard = [];
        this.tiers = [];
        this.masteryIconPath = "fs://game/techtree_icon-II.png";
        this.scale = 1;
        this.onScaleCardListener = this.onCardScale.bind(this);
    ...
    updateProgress() {
        ...
        for (let i = 0; i < this.tiers.length; i++) {
            ...
            const progressValue = depth.isCompleted ? "100" : depth.isLocked ? "0" : this.progress.toString();
            ringMeter.setAttribute("value", progressValue);
        }
    }
    updateQueueOrder() {
...
//# sourceMappingURL=file:///base-standard/ui/tree-grid/tree-card.js.map
