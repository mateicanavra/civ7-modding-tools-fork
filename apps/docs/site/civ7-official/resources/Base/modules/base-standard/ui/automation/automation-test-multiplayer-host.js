...
class AutomationTestPlayGame extends AutomationBasePlayGame {
    constructor() {
        ...
        this.automationTestMultiplayerHostListener = (command, ...args) => { this.onAutomationEvent(command, args); };
        this.playerInfoChangedListener = () => { this.onPlayerInfoChanged(); };
    }
    register() {
...
//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-multiplayer-host.js.map
