...
class ScreenVictoryAchieved extends Panel {
    constructor(root) {
        super(root);
        this.onVictoriesButtonActivatedListener = this.onVictoriesButtonActivated.bind(this);
    ...
    onReceiveFocus() {
        ...
        const viewProgressButton = MustGetElement(".victory-achieved__view-victories-button", this.Root);
...
class VictoryAchievedScreenManager extends DisplayHandlerBase {
    ...
    show(_request) {
        ...
        this.VictoryAchievedScreenElement ?? (this.VictoryAchievedScreenElement = Framework.ContextManager.push("screen-victory-achieved", { singleton: true, createMouseGuard: true, attributes: { 'data-milestone-id': _request.milestoneDefinition.$hash } }));
    }
...
//# sourceMappingURL=file:///base-standard/ui/victory-progress/screen-victory-achieved.js.map
