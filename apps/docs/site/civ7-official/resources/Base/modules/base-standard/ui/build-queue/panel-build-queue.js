...
class PanelBuildQueue extends Component {
    constructor() {
        ...
        this.itemEngineInputListener = this.onItemEngineInput.bind(this);
        this.itemFocusListener = this.onItemFocus.bind(this);
        this.deleteButtonListener = this.requestDelete.bind(this);
        this.upButtonListener = this.requestMoveUp.bind(this);
    ...
    onAttach() {
        ...
        Databind.for(itemContainerDiv, 'g_BuildQueue.items', 'item');
        {
            ...
            itemContainerHover.classList.add('build-queue__item-container-hover', 'absolute', 'size-full', 'pointer-events-auto', 'opacity-0', "hover\\:opacity-100", "focus\\:opacity-100", "selected\\:opacity-100", "active\\:opacity-100");
...
//# sourceMappingURL=file:///base-standard/ui/build-queue/panel-build-queue.js.map
