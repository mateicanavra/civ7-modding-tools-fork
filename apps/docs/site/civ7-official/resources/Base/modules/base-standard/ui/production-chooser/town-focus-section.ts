...
export class TownFocusChooserItem extends FxsChooserItem {
	...
	private readonly descriptionElement = document.createElement('div');
	private readonly projectIconElement = document.createElement('div');
	// #endregion
...
export class TownFocusSection extends FxsVSlot {
	// #region Element References
	private readonly townFocusItem = document.createElement('town-focus-chooser-item');
	private readonly defaultLabelElement = document.createElement('div');
	// #endregion
