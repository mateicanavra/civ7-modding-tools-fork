...
export class NotificationConnectionStatus extends Component {
    constructor() {
        super(...arguments);
        this.onDisconnection = this.showNotification.bind(this, HUD_OFFLINE_ICON);
        this.onReconnection = this.showNotification.bind(this, HUD_ONLINE_ICON);
    }
    onInitialize() {
        super.onInitialize();
...
//# sourceMappingURL=file:///base-standard/ui/notification-connection-status/notification-connection-status.js.map
