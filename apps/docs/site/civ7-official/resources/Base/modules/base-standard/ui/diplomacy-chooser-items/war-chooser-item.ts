...
export class WarChooserItem extends ChooserItem {
	private _warChooserData?: DiplomaticEventHeader;

	public set warChooserData(warData: DiplomaticEventHeader) {
	...
	render() {
		...
		const warData: WarData = Game.Diplomacy.getWarData(this._warChooserData.uniqueID, GameContext.localPlayerID);
...
declare global {
	interface HTMLElementTagNameMap {
		'war-chooser-item': ComponentRoot<WarChooserItem>
	}
}
