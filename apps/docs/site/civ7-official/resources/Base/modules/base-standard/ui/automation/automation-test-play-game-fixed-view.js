...
class AutomationTestPlayGameFixedView extends AutomationBasePlayGameXR {
    constructor() {
        super(...arguments);
        this.automationTestPlayGameFixedViewListener = (command, ...args) => {
...
let automationTestPlayGameFixedViewHandler = new AutomationTestPlayGameFixedView();
automationTestPlayGameFixedViewHandler.register();
Automation.setScriptHasLoaded("automation-test-play-game-fixed-view");

//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-play-game-fixed-view.js.map
