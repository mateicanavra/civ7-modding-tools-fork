...
import { ConstructibleData } from "/base-standard/ui/city-details/model-city-details.js";


class PeaceDealTooltipType implements TooltipType {

	private hoveredNodeID: string | null = null;
	private hoveredElement: HTMLElement = document.createElement("div");
	private occupied: string | null = null;

	private readonly container = document.createElement('fxs-tooltip');
	private readonly headerContainer = document.createElement("div");
	private readonly settlementName = document.createElement("div");
	private readonly settlementNameWrapper = document.createElement("div");
	private readonly settlementIcon = document.createElement("div");
	private readonly occupiedWrapper = document.createElement("div");
	private readonly occupiedIcon = document.createElement("div");
	private readonly occupiedText = document.createElement("div");
	private readonly populationWrapper = document.createElement("div");
	private readonly populationValueWrapper = document.createElement("div");
	private readonly yieldsTitleWrapper = document.createElement("div");
	private readonly mainYieldWrapper = document.createElement("div");
	private readonly resourcesTitleWrapper = document.createElement("div");
	private readonly resourcesWrapper = document.createElement("div");
	private readonly wondersTitleWrapper = document.createElement("div");
	private readonly wondersWrapper = document.createElement("div");
	...
	update(): void {
		...
		const myCity: City | null = Cities.get(myCityID);
		...
		if (myCity) {
			...
			for (const resourceEntry of cityResources) {
				...
				const resourceDefinition: ResourceDefinition | null = GameInfo.Resources.lookup(resourceEntry.uniqueResource.resource);
				...
				if (myCity.Constructibles?.getNumWonders() > 0) {
					...
					if (constructibles) {
						for (const constructibleID of constructibles.getIds()) {
							...
							const constructibleData: ConstructibleData = {
								id: constructibleID,
