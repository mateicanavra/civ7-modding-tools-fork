...
class ScreenUnlocks extends Panel {
    constructor(root) {
        super(root);
        this.closeButtonListener = this.askForClose.bind(this);
        this.playerUnlockChangedListener = this.onPlayerUnlockChanged.bind(this);
        this.playerUnlockProgressChangedListener = this.onPlayerUnlockProgressChanged.bind(this);
        this.navigateInputListener = this.onNavigateInput.bind(this);
        this.engineInputListener = this.onEngineInput.bind(this);
        this.tabBarListener = this.onTabBarSelected.bind(this);
        this.civShowDetailsListener = this.onShowDetailActivate.bind(this);
        this.activeDeviceChangedListener = this.onActiveDeviceChange.bind(this);
        this.refreshHandle = 0;
        this.refreshCallback = () => { this.onRefresh(); };
        this.playerUnlockContent = document.createElement('fxs-slot-group');
        this.civUnlockScrollSlots = null;
        this.showAllRequirements = false;
        this.extraRequirements = [];
        this.showAllRequirementsCheckbox = document.createElement('fxs-checkbox');
        this.showDetailsText = document.createElement('h3');
        this.agelessBackgroundImage = null;
        this.agelessBackgroundContainer = null;
        this.availableUnlockItems = [];
        this.ageChronology = new Map();
    ...
    populateCivList(root) {
        ...
        for (const reward of civUnlocks) {
            ...
            unlocksItem.classList.add('screen-unlocks__item', 'flow-row', 'flex-auto', 'min-h-32', 'w-full', 'my-1', 'bg-primary', 'justify-between', 'bg-center', 'relative', "bg-cover", "group");
            ...
            backgroundOverlayHover.classList.add('unlock-frame-hover', 'absolute', 'w-full', 'h-full', 'opacity-0', "group-hover\\:opacity-100", "group-focus\\:opacity-100");
...
//# sourceMappingURL=file:///base-standard/ui/unlocks/screen-unlocks.js.map
