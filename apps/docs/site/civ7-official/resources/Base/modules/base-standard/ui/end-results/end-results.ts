...
export const EndResultsFinishedEventName = 'end-results-finished' as const;
...
import EndGame, { PlayerAgeScore } from '/base-standard/ui/endgame/model-endgame.js';
...
class EndResultsScreen extends Panel {
	...
	onAttach(): void {
		...
		let titleString: string = "LOC_UI_PLAIN_DEFEAT";
		let mainGraphicURL: string = "url('fs://game/final_defeat-bg.png')";
		let textColorClass: string = "text-primary-1";
		let revealSound: string = "data-audio-final-defeat";
		...
		let leaderPortrait: string = Icon.getLeaderPortraitIcon(player.leaderType);
		let leaderIcon: string = Icon.getCivSymbolFromCivilizationType(player.civilizationType);
