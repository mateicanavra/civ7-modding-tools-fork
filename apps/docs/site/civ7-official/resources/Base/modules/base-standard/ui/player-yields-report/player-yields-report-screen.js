...
class PlayerYieldsReportScreen extends Panel {
    constructor() {
        super(...arguments);
        this.collapseToggleActivatedListener = this.onCollapseToggleActivated.bind(this);
    ...
    onCollapseToggle(container, collapsible) {
...
//# sourceMappingURL=file:///base-standard/ui/player-yields-report/player-yields-report-screen.js.map
