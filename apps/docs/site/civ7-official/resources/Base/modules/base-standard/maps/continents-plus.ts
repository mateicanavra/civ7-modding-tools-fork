...
function generateMap() {
	...
	let bIsBalanced: boolean = (startPosition == startPositionHash) || naturalWonderEvent;
	if (bIsBalanced) {
		console.log("Balanced Map");
		let iRandom: number = !naturalWonderEvent ? TerrainBuilder.getRandomNumber(2, "East or West") : 0; // don't want random hemisphere shuffle for live event
