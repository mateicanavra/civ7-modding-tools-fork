...
var CalloutContentType;
(function (CalloutContentType) {
    CalloutContentType[CalloutContentType["TITLE"] = 0] = "TITLE";
    CalloutContentType[CalloutContentType["BASE"] = 1] = "BASE";
    CalloutContentType[CalloutContentType["ADVISOR"] = 2] = "ADVISOR";
})(CalloutContentType || (CalloutContentType = {}));
/**
...
class TutorialCallout extends Component {
    ...
    constructor(root) {
        ...
        this.focusSet = false; // Has a focus lock been requested?
        this.isMinimized = false;
        this.engineInputListener = this.onEngineInput.bind(this);
        this.contextChangedInputListener = this.onContextChanged.bind(this);
        this.activeDeviceTypeListener = this.render.bind(this);
        this.activeContextChangedListener = this.render.bind(this);
    ...
    getContentData(type = CalloutContentType.BASE) {
...
//# sourceMappingURL=file:///base-standard/ui/tutorial/tutorial-callout.js.map
