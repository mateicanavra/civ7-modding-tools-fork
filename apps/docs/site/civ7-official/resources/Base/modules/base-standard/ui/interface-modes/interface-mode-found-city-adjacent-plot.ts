...
interface FoundCityAdjacentPlotInterfaceModeContext extends InterfaceMode.Context {
	UnitID: ComponentID;
...
class FoundCityAdjacentPlotInterfaceMode extends ChoosePlotInterfaceMode {
	...
	initialize() {
		const context = this.Context as FoundCityAdjacentPlotInterfaceModeContext;
		const args: any = {};
