...
const state = {
	initialized: false,
	enabled: false,
	cityInitializedHandle: null as EventHandle | null,
	debugWidgetUpdatedHandle: null as EventHandle | null,
	fixedWorldAnchorsChangedHandle: null as EventHandle | null,
	cameraChangedHandle: null as EventHandle | null,

	container: null as HTMLDivElement | null,

	_banners: null as CityBannerComponent[] | null,
	get banners() {
		if (this._banners) {
...
const CityBannerDebugWidget: Readonly<UIDebugWidgetDefinition> = {
...
const onDebugWidgetUpdated = (id: string, value: boolean) => {
