...
export function generateDiscoveries(iWidth, iHeight, startingPositions) {
    ...
    for (let iY = iHeight - 1; iY >= 0; iY--) {
        for (let iX = 0; iX < iWidth; iX++) {
            ...
            if (poisson[index] >= 1) {
                let iLocation = GameplayMap.getLocationFromIndex(index);
...
//# sourceMappingURL=file:///base-standard/maps/discovery-generator.js.map
