...
class PanelAgeRankings extends Panel {
    constructor() {
        ...
        this.boundOnSelectedAgeChanged = this.onSelectedAgeChanged.bind(this);
        this.onFocus = () => {
    ...
    render() {
        ...
        for (const victory of victoryData) {
            ...
            ageProgressTotal.innerHTML = Locale.compose('LOC_UI_AGE_RANKINGS_POINTS', AgeRankings.getMilestonesCompleted(victory.Type), AgeRankings.getMaxMilestoneProgressionTotal(victory.Type));
...
//# sourceMappingURL=file:///base-standard/ui/age-rankings/panel-age-rankings.js.map
