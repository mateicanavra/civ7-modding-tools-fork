...
class BefriendIndependentDetailsScreen extends Panel {
    ...
    populateBefriendIndependentDetails() {
        ...
        if (activeEvents.length > 0) {
            ...
            const normalizedProgress = (activeEvents[0].progressScore / activeEvents[0].completionScore);
            ...
            const otherCompletionData = Game.Diplomacy.getCompletionData(activeEvents[0].uniqueID);
        ...
        let supportResult = Game.PlayerOperations.canStart(GameContext.localPlayerID, PlayerOperationTypes.SUPPORT_DIPLOMATIC_ACTION, supportArgs, false);
...
//# sourceMappingURL=file:///base-standard/ui/befriend-independent-details/screen-befriend-independent-details.js.map
