...
(function (City) {
    ...
    City.isQueueEmpty = isQueueEmpty;
    /**
...
export class CitySelection {
    ...
    onReady() {
        engine.on('CitySelectionChanged', (data) => { this.onCitySelectionChanged(data); });
    }
    /**
...
//# sourceMappingURL=file:///base-standard/ui/city-selection/city-selection.js.map
