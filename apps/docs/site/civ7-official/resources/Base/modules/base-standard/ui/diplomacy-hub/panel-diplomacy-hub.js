...
class DiplomacyHubPanel extends DiplomacyInputPanel {
    constructor(root) {
        super(root);
        this.interfaceModeChangedListener = () => { this.onInterfaceModeChanged(); };
        this.diplomacyDialogNextListener = () => { this.onNextDiplomacyDialog(); };
        this.diplomacyDialogUpdateResponseListener = () => { this.onUpdateResponse(); };
        this.diplomacyAnimationFinishedListener = (event) => { this.onDiplomacyAnimationFinished(event); };
        this.viewReceiveFocusListener = () => { this.onViewReceiveFocus(); };
        this.diplomacyEventResponseListener = (eventData) => { this.onDiplomacyEventResponse(eventData); };
        this.isSkipAllowed = false;
        this.hasSkipped = false;
        this.isShowingActionResponse = false;
        this.updateSkipLabel = (event) => {
        ...
        if (DiplomacyManager.isDeclareWarDiplomacyOpen || DiplomacyManager.currentDiplomacyDialogData.StatementTypeDef?.GroupType == "WAR") {
            ...
            DiplomacyManager.currentDiplomacyDialogData.Choices.forEach((dialogOption, index) => {
                if (dialogOption.ChoiceType == "CHOICE_EXIT") {
                    ...
                    let diploPath = UI.getIconURL("NOTIFICATION_DIPLOMATIC_ACTION");
...
//# sourceMappingURL=file:///base-standard/ui/diplomacy-hub/panel-diplomacy-hub.js.map
