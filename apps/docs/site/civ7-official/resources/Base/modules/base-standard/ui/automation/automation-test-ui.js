...
class AutomationTestUI {
    constructor() {
        this.observer = -1;
        this.automationTestUIListener = (command, ...args) => { this.onAutomationEvent(command, args); };
        this.actions = [
...
//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-ui.js.map
