...
export var NotificationHandlers;
(function (NotificationHandlers) {
    ...
    NotificationHandlers.DefaultHandler = DefaultHandler;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.NewPopulationHandler = NewPopulationHandler;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.CommandUnits = CommandUnits;
    ...
    NotificationHandlers.ConsiderRazeCity = ConsiderRazeCity;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseCelebration = ChooseCelebration;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseGovernment = ChooseGovernment;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseTech = ChooseTech;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseCultureNode = ChooseCultureNode;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ViewCultureTree = ViewCultureTree;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ViewPoliciesChooserNormal = ViewPoliciesChooserNormal;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ViewPoliciesChooserCrisis = ViewPoliciesChooserCrisis;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ViewAttributeTree = ViewAttributeTree;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ViewVictoryProgress = ViewVictoryProgress;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseCityStateBonus = ChooseCityStateBonus;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseCityProduction = ChooseCityProduction;
    // -----------------------------------------------------------------------
    class CreateAdvancedStart extends DefaultHandler {
        activate(_notificationId, _activatedBy) {
            if (!Autoplay.isActive) {
                const HANGOUT_TIMEOUT = 30000;
    ...
    NotificationHandlers.CreateAdvancedStart = CreateAdvancedStart;
    // -----------------------------------------------------------------------
    ...
    CreateAgeTransition.didDisplayBanner = false;
    NotificationHandlers.CreateAgeTransition = CreateAgeTransition;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.AssignNewResources = AssignNewResources;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.AssignNewPromotionPoint = AssignNewPromotionPoint;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseTownProject = ChooseTownProject;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseNarrativeDirection = ChooseNarrativeDirection;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChoosePantheon = ChoosePantheon;
    ...
    NotificationHandlers.ChooseReligion = ChooseReligion;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.ChooseBelief = ChooseBelief;
    // -----------------------------------------------------------------------
    ...
    NotificationHandlers.InvestigateDiplomaticAction = InvestigateDiplomaticAction;
    ...
    NotificationHandlers.AllyAtWar = AllyAtWar;
    ...
    NotificationHandlers.DeclareWar = DeclareWar;
    ...
    NotificationHandlers.GameInvite = GameInvite;
    ...
    NotificationHandlers.KickVote = KickVote;
    ...
    NotificationHandlers.RespondToDiplomaticAction = RespondToDiplomaticAction;
    ...
    NotificationHandlers.RelationshipChanged = RelationshipChanged;
    class AdvisorWarning extends DefaultHandler {
        constructor(advisorType) {
            super();
            this.advisorType = TutorialAdvisorType.Default;
    ...
    NotificationHandlers.AdvisorWarning = AdvisorWarning;
    ...
    NotificationHandlers.ActionEspionage = ActionEspionage;
    ...
    NotificationHandlers.AgeProgression = AgeProgression;
    ...
    NotificationHandlers.CapitalLost = CapitalLost;
    ...
    NotificationHandlers.RewardUnlocked = RewardUnlocked;
    ...
    NotificationHandlers.GreatWorkCreated = GreatWorkCreated;
...
//# sourceMappingURL=file:///base-standard/ui/notification-train/notification-handlers.js.map
