...
//-----------------------------------------------------------------
export function SharedGame_OnAutoPlayEnd() {
...
//-----------------------------------------------------------------
export function LookAtCapital(ePlayer) {
    if (ePlayer !== -1) {
...
//-----------------------------------------------------------------
export function StartupObserverCamera(observeAs) {
...
//-----------------------------------------------------------------
export function GetFloatParam(paramName, defaultValue = 0.0) {
    return parseFloat(Automation.getParameter("CurrentTest", paramName, defaultValue));
}
//-----------------------------------------------------------------
export function GetFloat3Param(paramX, paramY, paramZ, defaultValue = { x: 0, y: 0, z: 0 }) {
    return {
...
//-----------------------------------------------------------------
export function PassTest(message = "") {
    engine.trigger("AutomationTestPassed", message);
}
//-----------------------------------------------------------------
export function FailTest(message = "") {
    engine.trigger("AutomationTestFailed", message);
}
//-----------------------------------------------------------------
export function Shared_OnAutomationEvent(args) {
...
class AutomationQuitApp {
    constructor() {
        this.automationTestQuitAppListener = (command) => { this.onAutomationEvent(command); };
    }
    register() {
...
class AutomationQuitGame {
    constructor() {
        this.automationTestQuitGameListener = (command, option) => { this.onAutomationEvent(command, option); };
    }
    register() {
...
class AutomationTestLoopTests {
    constructor() {
        this.automationTestLoopTestsListener = (command) => { this.onAutomationEvent(command); };
    }
    register() {
...
class AutomationPauseGame {
    constructor() {
        this.automationTestPauseGameListener = (command, ...args) => { this.onAutomationEvent(command, args); };
        this.waitForListener = () => { this.onWaitFor(); };
        this.waitForListenerHandle = null;
        this.unpauseListener = () => { this.onUnpause(); };
        this.onUnpauseListenerHandle = null;
    }
    register() {
...
class AutomationEnd {
    constructor() {
        this.automationTestEndListener = (command) => { this.onAutomationEvent(command); };
    }
    register() {
...
class AutomationTestManager {
    constructor() {
        this.automationRunTestListener = (option) => { this.onAutomationRunTest(option); };
        this.automationStopTestListener = () => { this.onAutomationStopTest(); };
        this.automationGameStartedListener = () => { this.onAutomationGameStarted(); };
        this.automationPostGameInitializationListener = (bWasLoad) => { this.onAutomationPostGameInitialization(bWasLoad); };
        this.automationCompleteListener = () => { this.onAutomationComplete(); };
        this.automationTestCompleteListener = () => { this.onAutomationTestComplete(); };
        this.automationTestPassedListener = (message) => { this.onAutomationTestPassed(message); };
        this.automationTestFailedListener = (message) => { this.onAutomationTestFailed(message); };
        this.automationStartListener = () => { this.onAutomationStart(); };
        this.automationMainMenuStartedListener = () => { this.onAutomationMainMenuStarted(); };
        this.automationAppInitCompleteListener = () => { this.onAutomationAppInitComplete(); };
...
//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-support.js.map
