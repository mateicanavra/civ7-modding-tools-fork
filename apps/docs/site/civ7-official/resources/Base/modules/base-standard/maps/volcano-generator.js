...
export function addVolcanoes(iWidth, iHeight, spacing = 2) {
    console.log("Volcanoes");
    let iMountainPercentByDistance = [30, 18, 6];
...
export function isTooCloseToExistingVolcanoes(iX, iY, existingVolcanoes, minDistance) {
...
export function addTundraVolcanoes(iWidth, iHeight, spacing = 3) {
    ...
    for (const { x, y } of tundraCandidates) {
        if (tundraVolcanoesPlaced >= iDesiredVolcanoes)
            break;
...
//# sourceMappingURL=file:///base-standard/maps/volcano-generator.js.map
