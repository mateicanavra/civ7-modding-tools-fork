...
class AutomationTestProduction extends AutomationBasePlayGame {
    constructor() {
        ...
        this.observer = -1;
        this.produceTag = -1;
        this.automationTestProductionListener = (command, ...args) => { this.onAutomationEvent(command, args); };
    }
    register() {
...
//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-production.js.map
