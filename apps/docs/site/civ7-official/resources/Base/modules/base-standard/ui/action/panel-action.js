...
export class PanelAction extends Panel {
    constructor() {
        super(...arguments);
        this.actionButton = document.createElement("fxs-activatable");
        this.notificationIcon = document.createElement("div");
        this.actionText = document.createElement("p");
        this.lastPlayerMessageContainer = null;
        this.navHelpContainer = null;
        this.lastPlayerMessageVisibility = false;
        this.pleaseWaitAnimation = new SpriteSheetAnimation(this.notificationIcon, { imageName: "blp:ntf_pleasewait_anim", rows: 4, cols: 4, frames: 10 }, 1000);
        this.updateGate = new UpdateGate(this.onUpdate.bind(this));
        this.engineInputListener = this.onEngineInput.bind(this);
        this.activeDeviceChangedEventListener = this.onActiveDeviceChanged.bind(this);
        this.nextActionHotKeyListener = this.tryEndTurn.bind(this);
        this.centerButtonAnimListener = this.centerButtonAnimEnd.bind(this);
        this.notificationSlots = new Array(TURN_BLOCKING_NOTIFICATION_ICON_COUNT);
        this.onActionPanelBlockerActivated = (event) => {
    ...
    activateBlockingNotification() {
        ...
        if (this.showRemainingMovesState()) {
            ...
            let commandUnitHandler = NotificationModel.manager.findHandler(commandUnitType);
...
PanelAction.actionIconCache = new ImageCache();
...
//# sourceMappingURL=file:///base-standard/ui/action/panel-action.js.map
