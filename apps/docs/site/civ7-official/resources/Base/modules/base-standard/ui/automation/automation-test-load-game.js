...
class AutomationTestLoadGame {
    constructor() {
        this.automationTestLoadGameListener = (command) => { this.onAutomationEvent(command); };
        this.autoPlayEndListener = () => { this.onAutoPlayEnd(); };
        this.saveCompleteListener = () => { this.onSaveComplete(); };
        this.savesRemaining = 0;
    }
    register() {
...
//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-load-game.js.map
