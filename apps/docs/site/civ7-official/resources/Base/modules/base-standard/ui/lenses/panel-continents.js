 ...
 */
import { ContinentLensLayer } from "/base-standard/ui/lenses/layer/continent-layer.js";
...
export class ContinentLensInfo extends Panel {
    ...
    constructor(root) {
        super(root);
        this.subsystemFrameCloseListener = this.close.bind(this);
        this.engineInputListener = this.onEngineInput.bind(this);
        this.activeLensChangedListener = this.onActiveLensChanged.bind(this);
        this.continentListContainer = null;
        this.frame = null;
        this.inputContext = InputContext.World;
    }
    onAttach() {
    ...
    getContinentResearchState(continentType, isDistant) {
...
//# sourceMappingURL=file:///base-standard/ui/lenses/panel-continents.js.map
