...
export const FocusCityViewEventName = 'focus-city-view';
export class FocusCityViewEvent extends CustomEvent {
    constructor(detail) {
...
export class CityView {
    /// IGameView
    getName() { return "City"; }
    getInputContext() { return InputContext.Dual; }
    getHarnessTemplate() { return "city"; }
    /// IGameView
    enterView() {
    }
    /// IGameView
...
//# sourceMappingURL=file:///base-standard/ui/views/view-city.js.map
