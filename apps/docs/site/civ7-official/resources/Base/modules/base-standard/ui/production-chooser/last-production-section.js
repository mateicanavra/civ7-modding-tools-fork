...
export class LastProductionSection extends Component {
    constructor() {
        super(...arguments);
        this.cityID = null;
        this.updateCityDetailsListener = this.onUpdateCityDetails.bind(this);
        this.nameElement = document.createElement('div');
        this.iconElement = document.createElement('fxs-icon');
        this.yieldDiv = document.createElement('div');
...
//# sourceMappingURL=file:///base-standard/ui/production-chooser/last-production-section.js.map
