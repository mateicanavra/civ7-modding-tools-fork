...
class AutomationTestPlayGame extends AutomationBasePlayGame {
    constructor() {
        super(...arguments);
        this.automationTestPlayGameListener = (command, ...args) => { this.onAutomationEvent(command, args); };
    }
    register() {
...
//# sourceMappingURL=file:///base-standard/ui/automation/automation-test-play-game.js.map
