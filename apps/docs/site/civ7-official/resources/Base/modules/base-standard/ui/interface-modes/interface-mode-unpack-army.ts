/**
 * @file interface-mode-unpack-army.ts
...
interface UnpackArmyInterfaceModeContext extends InterfaceMode.Context {
	UnitID: ComponentID;
	OperationArguments: any;
}
/**
 * Handler for INTERFACEMODE_UNPACK_ARMY.
 */
class UnpackArmyInterfaceMode extends ChoosePlotInterfaceMode {
	...
	initialize() {
		const context = this.Context as UnpackArmyInterfaceModeContext;
		const args: any = {};
