...
var ContinueButtonState;
(function (ContinueButtonState) {
    ContinueButtonState[ContinueButtonState["SHOW_REWARDS"] = 0] = "SHOW_REWARDS";
    ContinueButtonState[ContinueButtonState["CONTINUE_AGE_TRANSTIION"] = 1] = "CONTINUE_AGE_TRANSTIION";
    ContinueButtonState[ContinueButtonState["EXIT_TO_MAIN_MENU"] = 2] = "EXIT_TO_MAIN_MENU";
})(ContinueButtonState || (ContinueButtonState = {}));
class ScreenLegendsReport extends Panel {
    constructor() {
        super(...arguments);
        this.foundationChallengesDiv = null;
        this.leaderChallengesDiv = null;
        this.continueButtonState = ContinueButtonState.SHOW_REWARDS;
        this.leaderMeter = document.createElement('fxs-ring-meter');
        this.foundationMeter = document.createElement('fxs-ring-meter');
    ...
    render() {
        ...
        this.foundationChallengesDiv = this.createChallenges(legendsData.completedFoundationChallenge, "LOC_UI_LEGENDS_REPORT_PLUS_FOUNDATION_XP");
        ...
        // Leader Challenges
        this.leaderChallengesDiv = this.createChallenges(legendsData.completedLeaderChallenge, "LOC_UI_LEGENDS_REPORT_PLUS_LEADER_XP");
...
//# sourceMappingURL=file:///base-standard/ui/legends-report/screen-legends-report.js.map
