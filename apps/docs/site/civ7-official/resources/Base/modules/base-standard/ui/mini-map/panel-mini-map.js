...
export class PanelMiniMap extends Panel {
    constructor(root) {
        ...
        this.lensPanel = document.createElement('div');
        ...
        this.toggleMiniMapListener = this.onToggleMiniMap.bind(this);
...
export class ToggleMiniMapEvent extends CustomEvent {
    constructor(value) {
