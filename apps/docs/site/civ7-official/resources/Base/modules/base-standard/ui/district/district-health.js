...
export class DistrictHealthBar extends Component {
    constructor() {
        super(...arguments);
        ...
        this.civHexInner = null;
        this.civHexOuter = null;
        this.isCityCenter = false;
        this.MEDIUM_HEALTH_THRESHHOLD = .75; // thresholds for health bar color changes
...
//# sourceMappingURL=file:///base-standard/ui/district/district-health.js.map
