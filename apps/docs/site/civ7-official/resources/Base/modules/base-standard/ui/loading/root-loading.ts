...
// TODO: import this code from another module (can't for now as root-loading is not a module)
...
window.addEventListener('load', function () {
	...
	if (shouldTransition()) {
		...
		const whenReadyToTransition = new Promise<void>((resolve, _reject) => {
...
function updateLoadingBarWidthRatio(numerator: number, denominator: number) {
	const loadingBarProgress = document.querySelector<HTMLElement>('.loading__loading-bar-progress');
