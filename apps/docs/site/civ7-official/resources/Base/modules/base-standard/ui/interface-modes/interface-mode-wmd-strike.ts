...
interface WMDStrikeInterfaceModeContext extends InterfaceMode.Context {
	UnitID: ComponentID;
...
/**
 * Handler for INTERFACEMODE_WMD_STRIKE.
 */
class WMDStrikeInterfaceMode extends ChoosePlotInterfaceMode {
	...
	initialize() {
		const context = this.Context as WMDStrikeInterfaceModeContext;
		const args: any = {};
