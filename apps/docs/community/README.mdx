---
title: "Civilization VII Modding: Community"
description: "Community modding documentation for Civilization VII"
...
New to Civilization VII modding? Start with our [Getting Started Guide](/community/guides/getting-started) to learn the basics and set up your environment. Then explore the various sections to dive deeper into specific aspects of modding.

For a comprehensive overview of all documentation with contextual descriptions and recommended learning paths, check out our [Documentation Guide](/community/documentation-guide).
...
- **Learning Paths**: Recommended document sequences for different skill levels in the [Documentation Guide](/community/documentation-guide)
