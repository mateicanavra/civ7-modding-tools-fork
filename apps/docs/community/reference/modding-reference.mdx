...
Key components include:
``` sql lines icon="/icons/icon-code-sql.svg" id="community-reference-modding-reference__23da942b" tag="sql"
...
Key components include:
``` sql lines icon="/icons/icon-code-sql.svg" id="community-reference-modding-reference__19225e8c" tag="sql"
CREATE TABLE 'Icons' (
    'ID' TEXT NOT NULL,
...
Key components include:
``` sql lines icon="/icons/icon-code-sql.svg" id="community-reference-modding-reference__34b70ae5" tag="sql"
CREATE TABLE "Map" (
    "ID" TEXT NOT NULL,
    "Width" INTEGER,
    "Height" INTEGER,
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__b18b08fd" tag="xml"
<Ages>
...
Example from config.xml:
``` xml lines icon="file-xml" id="community-reference-modding-reference__89495eab" tag="xml"
<Ages>
...
Example from config.xml:
``` xml lines icon="file-xml" id="community-reference-modding-reference__5c1423be" tag="xml"
<Ages>
...
Example structure:
``` json lines icon="file-code" id="community-reference-modding-reference__8b45088e" tag="json"
{
  "CivilizationTypes": [
    {
...
Example structure:
``` json lines icon="file-code" id="community-reference-modding-reference__f78148cc" tag="json"
{
  "LeaderTypes": [
    {
...
Example structure:
``` json lines icon="file-code" id="community-reference-modding-reference__fa89a1c4" tag="json"
{
  "UnitTypes": [
    {
      "UnitType": "UNIT_LEGION",
...
Example structure:
``` json lines icon="file-code" id="community-reference-modding-reference__5c360398" tag="json"
{
  "ConstructibleTypes": [
    {
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__85ed57e7" tag="xml"
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__255f0f67" tag="xml"
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__bb365200" tag="xml"
<Leaders>
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__d48563fb" tag="xml"
<Civilizations>
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__fd8c4ca6" tag="xml"
<GameData>
  <LocalizedText>
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__3da8d007" tag="xml"
<GameData>
  <IconDefinitions>
...
``` xml lines icon="file-xml" id="community-reference-modding-reference__bee224c1" tag="xml"
...
**macOS:**
``` text lines icon="text" id="community-reference-modding-reference__1b1db976" tag="text"
~/Library/Application Support/Civilization VII/Mods/
```

**Windows:**
``` text lines icon="text" id="community-reference-modding-reference__10129e36" tag="text"
...
``` text id="community-reference-modding-reference__1352df63" tag="file-tree" wrap
your-mod-name/
...
Example structure:
``` xml lines icon="file-xml" id="community-reference-modding-reference__facd9600" tag="xml"
