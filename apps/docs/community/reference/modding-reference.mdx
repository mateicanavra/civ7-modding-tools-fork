...
- Exploring the map system: [`civ7-map-system.md`](/community/reference/reference/map-system)
- Creating new civilizations: [`civ7-creating-civilizations.md`](/community/reference/guides/general-creating-civilizations)
- Creating new leaders: [`civ7-creating-leaders.md`](/community/reference/guides/general-creating-leaders)
- Modifying existing content: [`civ7-modifying-content.md`](/community/reference/guides/general-modifying-content)
- Using TypeScript modding tools: [`civ7-typescript-overview.md`](/community/reference/guides/typescript/typescript-overview) 