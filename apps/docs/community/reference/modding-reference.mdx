...
Key components include:
``` sql lines icon="database" id="community-reference-modding-reference__23da942b" tag="sql"
...
Key components include:
``` sql lines icon="database" id="community-reference-modding-reference__19225e8c" tag="sql"
CREATE TABLE 'Icons' (
    'ID' TEXT NOT NULL,
...
Key components include:
``` sql lines icon="database" id="community-reference-modding-reference__34b70ae5" tag="sql"
CREATE TABLE "Map" (
    "ID" TEXT NOT NULL,
    "Width" INTEGER,
    "Height" INTEGER,
