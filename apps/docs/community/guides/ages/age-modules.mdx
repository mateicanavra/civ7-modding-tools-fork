title: "Age Modules"
description: "Overview of Antiquity, Exploration, and Modern modules and their structures."
sidebarTitle: "Age Modules"
---
...
``` text id="community-guides-ages-age-modules__2ade3646" tag="file-tree" wrap
age-[name]/
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__e13bbaa4" tag="xml"
<Ages>
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__f159a592" tag="xml"
<Ages>
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__69d59a2e" tag="xml"
<Ages>
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__98ccaaa6" tag="xml"
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__e53d7208" tag="xml"
<CivilizationDomains>
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__1d384ec0" tag="xml"
<Units>
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__5e777eae" tag="xml"
<Buildings>
...
``` xml lines icon="file-xml" id="community-guides-ages-age-modules__1f93f977" tag="xml"
<Buildings>
