...
- [Age Modules](/community/guides/ages/guides/ages/age-modules) - Detailed documentation on age module structure and content
- [Age Gameplay Mechanics](/community/guides/ages/guides/ages/age-gameplay-mechanics) - Age-specific gameplay systems and mechanics
- [Base-Standard Module](/community/guides/ages/guides/base-standard-module) - Core structure that interacts with age modules 