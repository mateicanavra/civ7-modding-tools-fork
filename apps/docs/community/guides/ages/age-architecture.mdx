---
title: "Age System Architecture"
description: "Technical architecture of the Ages system and how modules interact."
...
``` xml lines icon="file-xml" id="community-guides-ages-age-architecture__66670075" tag="xml"
<GAME_RESOURCES>/Base/
...
``` xml lines icon="file-xml" id="community-guides-ages-age-architecture__fa3aaea3" tag="xml"
