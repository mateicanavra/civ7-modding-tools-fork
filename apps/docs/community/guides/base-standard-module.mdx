...
- For core architecture concepts, see [Civ7 Modding Architecture](/community/guides/guides/modding-architecture)
- For database schema details, see [Database Schemas](/community/guides/guides/database-schemas)
- For Age module specifics, see [Age Modules](/community/guides/guides/age-modules)
- For real-world examples, see [DLC and Community Mod Patterns](/community/guides/guides/mod-patterns)
