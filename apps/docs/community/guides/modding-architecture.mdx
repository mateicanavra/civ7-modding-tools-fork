...
Civilization VII's defining feature is its Ages system, which directly impacts how modding works. For detailed information on the Ages system, see the [Age Architecture](/community/guides/guides/ages/age-architecture) document.
...
- **age-antiquity**, **age-exploration**, **age-modern**: Age-specific content (details in [Age Architecture](/community/guides/guides/ages/age-architecture))
...
For details on handling age transitions in mods, see the [Age Architecture](/community/guides/guides/ages/age-architecture) document.
...
2. **Technical References**:
   - [Database Schemas](/community/guides/guides/database-schemas) - Detailed technical information about the game's internal structure
   - [Age Architecture](/community/guides/guides/ages/age-architecture) - Overall age system architecture
   - [Age Modules](/community/guides/guides/ages/age-modules) - Specifics about each Age module and its content
   - [Base-Standard Module](/community/guides/guides/base-standard-module) - Core structure and implementation patterns
   - [DLC and Community Mod Patterns](/community/guides/guides/mod-patterns) - Examples and best practices from existing mods
3. **Practical Guides**:
   - [General: Creating New Civilizations](/community/guides/guides/general-creating-civilizations) - Step-by-step guide for adding civilizations
   - [General: Creating New Leaders](/community/guides/guides/general-creating-leaders) - Process for implementing new leaders
   - [General: Modifying Existing Content](/community/guides/guides/general-modifying-content) - Approaches for balancing and changing game elements
4. **Appendices**:
   - [File Paths Reference](/community/guides/reference/file-paths-reference) - Common file paths and structures
...
2. Examine the [Database Schemas](/community/guides/guides/database-schemas) document to familiarize yourself with game tables
3. Follow the [General: Creating New Civilizations](/community/guides/guides/general-creating-civilizations) or [General: Modifying Existing Content](/community/guides/guides/general-modifying-content) guides for hands-on practice
4. Reference the [DLC and Community Mod Patterns](/community/guides/guides/mod-patterns) for real-world examples
...
- [Database Schemas](/community/guides/guides/database-schemas) - Detailed database schema reference
- [Base Standard Module](/community/guides/guides/base-standard-module) - Core game module documentation
- [General: Creating Civilizations](/community/guides/guides/general-creating-civilizations) - Process for implementing new civilizations
- [General: Creating Leaders](/community/guides/guides/general-creating-leaders) - Process for implementing new leaders
- [Age Modules](/community/guides/guides/ages/age-modules) - Understanding the Age module system 