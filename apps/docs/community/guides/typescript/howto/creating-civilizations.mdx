...
description: "Comprehensive tutorial for implementing new civilizations with the TypeScript toolkit."
---
...
``` typescript expandable id="community-guides-typescript-howto-creating-civilizations__1f6a805a" tag="file-tree" wrap
import {
    ACTION_GROUP_BUNDLE,
    CivilizationBuilder,
    ImportFileBuilder,
...
``` typescript icon="code" id="community-guides-typescript-howto-creating-civilizations__0c67e5b8" tag="code-snippet"
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-creating-civilizations__8e613e2f" tag="code-snippet"
import {
    UnitBuilder,
...
``` typescript icon="code" id="community-guides-typescript-howto-creating-civilizations__4dedfe6b" tag="code-snippet"
