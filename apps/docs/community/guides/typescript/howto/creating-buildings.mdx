...
sidebarTitle: "Buildings & Improvements"
description: "How to implement custom buildings and tile improvements using TypeScript tools."
---
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-creating-buildings__d6dd88ad" tag="code-snippet"
import { 
    ACTION_GROUP_BUNDLE, 
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-creating-buildings__06ffc330" tag="code-snippet"
import { 
    ACTION_GROUP_BUNDLE, 
    CONSTRUCTIBLE_TYPE_TAG, 
    ConstructibleBuilder, 
...
``` typescript icon="code" id="community-guides-typescript-howto-creating-buildings__828d7a61" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-howto-creating-buildings__e97030d7" tag="code-snippet"
