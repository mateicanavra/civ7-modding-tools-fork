---
title: "Creating Unique Quarters"
sidebarTitle: "Unique Quarters"
description: "How to create civilization-specific quarters and districts."
---
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-unique-quarters__34515bfb" tag="code-snippet"
import {
    ACTION_GROUP_BUNDLE,
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-unique-quarters__67fd6ccd" tag="code-snippet"
import {
    CivilizationBuilder,
    UniqueQuarterBuilder,
    ConstructibleBuilder,
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-unique-quarters__189b9dd9" tag="code-snippet"
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-unique-quarters__7efd1c7b" tag="code-snippet"
