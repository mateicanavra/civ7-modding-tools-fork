---
title: "Assets & Icons"
sidebarTitle: "Assets & Icons"
description: "Guide for importing, referencing, and managing custom visual assets."
---
...
``` typescript id="community-guides-typescript-howto-assets-and-icons__9bee7990" tag="file-tree" wrap
import {
    ACTION_GROUP_BUNDLE,
    ImportFileBuilder,
    Mod
...
``` typescript id="community-guides-typescript-howto-assets-and-icons__6c865f76" tag="file-tree" wrap
...
``` typescript expandable id="community-guides-typescript-howto-assets-and-icons__abd04ef3" tag="file-tree" wrap
import {
    ACTION_GROUP_BUNDLE,
    CivilizationBuilder,
    ImportFileBuilder,
...
``` typescript icon="code" id="community-guides-typescript-howto-assets-and-icons__76f1ecc3" tag="code-snippet"
...
``` typescript id="community-guides-typescript-howto-assets-and-icons__5ee2e86d" tag="file-tree" wrap
// Antiquity Age icon
...
``` typescript id="community-guides-typescript-howto-assets-and-icons__571b26b6" tag="file-tree" wrap
// Sound effect
...
``` typescript expandable id="community-guides-typescript-howto-assets-and-icons__1bd60933" tag="file-tree" wrap
import {
    ACTION_GROUP_BUNDLE,
    CivilizationBuilder,
    ImportFileBuilder,
