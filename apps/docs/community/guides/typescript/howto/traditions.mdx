...
sidebarTitle: "Traditions"
description: "Implementing custom traditions and policies with the TypeScript toolkit."
---
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-traditions__7e165a26" tag="code-snippet"
import {
    ACTION_GROUP_BUNDLE,
    Mod,
    ModifierBuilder,
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-traditions__663f60e9" tag="code-snippet"
import {
    ACTION_GROUP_BUNDLE,
    Mod,
    ModifierBuilder,
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-traditions__ad9e979f" tag="code-snippet"
import {
    ACTION_GROUP_BUNDLE,
    Mod,
    ModifierBuilder,
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-traditions__b3b67fe8" tag="code-snippet"
import {
    ACTION_GROUP_BUNDLE,
    Mod,
    ModifierBuilder,
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-traditions__1f705c92" tag="code-snippet"
import {
    ACTION_GROUP_BUNDLE,
    Mod,
    ModifierBuilder,
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-traditions__f4b0b5e7" tag="code-snippet"
import {
    ACTION_GROUP_BUNDLE,
    Mod,
    TraditionBuilder,
