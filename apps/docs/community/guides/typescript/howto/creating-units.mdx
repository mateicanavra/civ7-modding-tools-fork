...
sidebarTitle: "Creating Units"
description: "Step-by-step instructions for implementing custom units with TypeScript tools."
---
...
``` typescript expandable icon="code" id="community-guides-typescript-howto-creating-units__28f79fe5" tag="code-snippet"
import { 
    ACTION_GROUP_BUNDLE, 
    Mod, 
    UNIT, 
...
``` typescript icon="code" id="community-guides-typescript-howto-creating-units__99ea5e30" tag="code-snippet"
...
``` typescript id="community-guides-typescript-howto-creating-units__cf3ad73f" tag="file-tree" wrap
import { 
    ImportFileBuilder, 
    UnitBuilder 
} from "civ7-modding-tools";
