---
title: "TypeScript Modding Tools (Technical)"
sidebarTitle: "TS Tools Technical"
description: "Deep dive into the toolkit’s architecture, builders, nodes, and code structure."
---
...
1. **[Main Documentation](/community/guides/typescript/typescript-overview)** - Covers general concepts, features, and limitations
...
``` text id="community-guides-typescript-typescript-technical__097501bb" tag="file-tree" wrap
civ7-modding-tools/
├── src/
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__437be22e" tag="code-snippet"
...
``` typescript expandable icon="code" id="community-guides-typescript-typescript-technical__5e855252" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__2eff5f1e" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__54e9f656" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__422cba9d" tag="code-snippet"
...
``` xml lines icon="file-xml" id="community-guides-typescript-typescript-technical__bbe0b6d8" tag="xml"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__f706e380" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__2c02f654" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__2d82ad72" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__a9676508" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__d0c58f4a" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__3c9a47c3" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__38d3391d" tag="code-snippet"
...
``` typescript expandable icon="code" id="community-guides-typescript-typescript-technical__f39c30e7" tag="code-snippet"
export class Mod {
    id: string;
    version: string;
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__0f7c495c" tag="code-snippet"
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__a1542623" tag="code-snippet"
initialize() {
    // Create civilization node
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__fdf2e4ba" tag="code-snippet"
bind(entities: BaseBuilder[]) {
    entities.forEach(entity => {
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__f8afbe46" tag="code-snippet"
getFiles() {
...
``` typescript icon="code" id="community-guides-typescript-typescript-technical__0f4d35f8" tag="code-snippet"
// Add to mod
...
``` xml lines icon="file-xml" id="community-guides-typescript-typescript-technical__ea6d16bd" tag="xml"
...
- [Main Documentation](/community/guides/typescript/typescript-overview) - General overview and features
- [How-To Guides](/community/guides/typescript/howto/) - Step-by-step tutorials for common tasks
- [Modding Architecture Overview](/community/guides/modding-architecture) - General Civilization VII modding framework
