---
title: "TypeScript Modding Tools (Overview)"
sidebarTitle: "TS Tools Overview"
description: "Introduction to the TypeScript-based modding toolkit, features, and usage."
---
...
- **TypeScript Errors**: Ensure you have the correct version of TypeScript installed (`bun add -d typescript@latest`)
