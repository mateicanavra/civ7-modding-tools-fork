...
2. **[Technical Implementation Guide](/community/guides/typescript/guides/typescript/typescript-technical)** - Details the toolkit's architecture and internal workings
3. **How-To Guides**: A series of practical tutorials for common modding tasks:
   - [Environment Setup](/community/guides/typescript/guides/typescript/howto/environment-setup)
   - [Creating Units](/community/guides/typescript/guides/typescript/howto/creating-units)
   - [Creating Buildings](/community/guides/typescript/guides/typescript/howto/creating-buildings)
   - [Creating Civilizations](/community/guides/typescript/guides/typescript/howto/creating-civilizations)
   - [Leaders and Ages](/community/guides/typescript/guides/typescript/howto/leaders-and-ages)
   - [Unique Quarters](/community/guides/typescript/guides/typescript/howto/unique-quarters)
   - [Traditions](/community/guides/typescript/guides/typescript/howto/traditions)
   - [Progression Trees](/community/guides/typescript/guides/typescript/howto/progression-trees)
   - [Modifiers and Effects](/community/guides/typescript/guides/typescript/howto/modifiers-and-effects)
   - [Assets and Icons](/community/guides/typescript/guides/typescript/howto/assets-and-icons)
   - [Advanced Techniques](/community/guides/typescript/guides/typescript/howto/advanced-techniques)
...
For detailed examples of how to create specific elements, see the [How-To Guide](/community/guides/typescript/guides/typescript/howto/index).
...
- [Modding Architecture Overview](/community/guides/typescript/guides/modding-architecture)
- [Database Schemas Reference](/community/guides/typescript/guides/database-schemas)
- [General: Creating New Civilizations](/community/guides/typescript/guides/general-creating-civilizations)
- [General: Creating New Leaders](/community/guides/typescript/guides/general-creating-leaders)
- [General: Modifying Existing Content](/community/guides/typescript/guides/general-modifying-content)
- [TypeScript Technical Implementation](/community/guides/typescript/guides/typescript/typescript-technical)
- [TypeScript How-To Guides](/community/guides/typescript/guides/typescript/howto/index) 