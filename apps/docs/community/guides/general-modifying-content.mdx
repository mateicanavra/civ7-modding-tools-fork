...
1. A basic understanding of the Civilization VII modding architecture (see [Modding Architecture](/community/guides/guides/modding-architecture))
2. Familiarity with the relevant database schemas (see [Database Schemas](/community/guides/guides/database-schemas))
3. Knowledge of the Age system (see [Age Modules](/community/guides/guides/age-modules))
4. The game's base files for reference
5. A working knowledge of creating content (see [General: Creating Civilizations](/community/guides/guides/general-creating-civilizations) and [General: Creating Leaders](/community/guides/guides/general-creating-leaders))
...
- [Modding Architecture](/community/guides/guides/modding-architecture)
- [Database Schemas](/community/guides/guides/database-schemas)
- [General: Creating Civilizations](/community/guides/guides/general-creating-civilizations)
- [General: Creating Leaders](/community/guides/guides/general-creating-leaders)
- [DLC and Community Mod Patterns](/community/guides/guides/mod-patterns)
