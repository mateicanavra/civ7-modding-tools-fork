...
``` sql lines icon="database" id="community-guides-general-modifying-content__33868443" tag="sql"
...
``` sql lines icon="database" id="community-guides-general-modifying-content__10dbe1ee" tag="sql" expandable
...
``` sql lines icon="database" id="community-guides-general-modifying-content__92e60a4c" tag="sql"
