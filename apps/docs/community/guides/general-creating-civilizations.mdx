...
2. Familiarity with the game's database schema (see [Database Schemas](/community/guides/guides/database-schemas))
...
- [Age Modules](/community/guides/guides/age-modules)
