...
- For base game architecture, see [Civ7 Modding Architecture](/community/guides/guides/modding-architecture)
- For file path references, see [Civ7 File Paths Reference](/community/guides/reference/file-paths-reference)
- For creating civilizations, see [General: Creating Civilizations](/community/guides/guides/general-creating-civilizations)
- For the TypeScript modding tools, see [TypeScript Modding Tools](/community/guides/guides/typescript/typescript-overview)
