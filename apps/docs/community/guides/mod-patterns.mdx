---
title: "DLC and Community Mod Patterns"
sidebarTitle: "Mod Patterns"
...
``` xml lines icon="file-xml" id="community-guides-mod-patterns__6ebd7be4" tag="xml"
...
``` text lines icon="text" id="community-guides-mod-patterns__8e7526e3" tag="text"
LOC_MODID_CATEGORY_NAME_TEXT
```

For example:
``` text lines icon="text" id="community-guides-mod-patterns__902287b2" tag="text"
...
- For base game architecture, see [Civ7 Modding Architecture](/community/guides/modding-architecture)
- For file path references, see [Civ7 File Paths Reference](/community/reference/file-paths-reference)
- For creating civilizations, see [General: Creating Civilizations](/community/guides/general-creating-civilizations)
- For the TypeScript modding tools, see [TypeScript Modding Tools](/community/guides/typescript/typescript-overview)
