...
``` sql lines icon="database" id="community-guides-database-schemas__76e3263e" tag="sql"
...
``` sql lines icon="database" id="community-guides-database-schemas__b1c23c3d" tag="sql"
...
``` sql lines icon="database" id="community-guides-database-schemas__847e90ef" tag="sql"
CREATE TABLE "Units" (
...
``` sql lines icon="database" id="community-guides-database-schemas__98bc518c" tag="sql"
...
``` sql lines icon="database" id="community-guides-database-schemas__0e0d6a97" tag="sql" expandable
CREATE TABLE Mods(
...
``` sql lines icon="database" id="community-guides-database-schemas__19225e8c" tag="sql"
CREATE TABLE 'Icons' (
    'ID' TEXT NOT NULL,
...
``` sql lines icon="database" id="community-guides-database-schemas__c98e61f2" tag="sql" expandable
CREATE TABLE "Map" (
    "ID" TEXT NOT NULL,
    "Width" INTEGER,
    "Height" INTEGER,
...
``` sql lines icon="database" id="community-guides-database-schemas__748f8068" tag="sql"
