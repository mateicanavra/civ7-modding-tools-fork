...
description: "Technical reference for core game data structures, tables, and relationships."
---
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__76e3263e" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__b1c23c3d" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__847e90ef" tag="sql"
CREATE TABLE "Units" (
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__98bc518c" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__0e0d6a97" tag="sql" expandable
CREATE TABLE Mods(
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__19225e8c" tag="sql"
CREATE TABLE 'Icons' (
    'ID' TEXT NOT NULL,
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__c98e61f2" tag="sql" expandable
CREATE TABLE "Map" (
    "ID" TEXT NOT NULL,
    "Width" INTEGER,
    "Height" INTEGER,
...
``` sql lines icon="/icons/icon-code-sql.svg" id="community-guides-database-schemas__748f8068" tag="sql"
...
``` xml lines icon="file-xml" id="community-guides-database-schemas__af3069fd" tag="xml"
{/*Adding a new civilization*/}
<Civilizations>
...
``` xml lines icon="file-xml" id="community-guides-database-schemas__59492112" tag="xml"
{/*Adding a new leader*/}
<Leaders>
...
``` xml lines icon="file-xml" id="community-guides-database-schemas__10d0d71f" tag="xml"
...
- For implementation guidance, see [Creating New Civilizations](/community/guides/general-creating-civilizations)
- For file organization, see [Civilization VII Modding Architecture](/community/guides/modding-architecture)
- For examples from existing content, see [DLC and Community Mod Patterns](/community/guides/mod-patterns)
