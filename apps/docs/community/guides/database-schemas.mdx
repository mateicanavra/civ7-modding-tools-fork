...
- For implementation guidance, see [Creating New Civilizations](/community/guides/guides/creating-civilizations)
- For file organization, see [Civilization VII Modding Architecture](/community/guides/guides/modding-architecture)
- For examples from existing content, see [DLC and Community Mod Patterns](/community/guides/guides/mod-patterns)
