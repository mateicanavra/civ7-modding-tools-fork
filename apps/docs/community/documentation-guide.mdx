...
- **Related documents**: [Creating Civilizations](/community/guides/creating-civilizations), [Creating Leaders](/community/guides/creating-leaders)

## Content Creation

### [Creating Civilizations](/community/guides/creating-civilizations) 🟡
...
- **Related documents**: [Creating Leaders](/community/guides/creating-leaders), [Dacia Implementation Guide](/community/guides/examples/dacia-implementation-guide)

### [Creating Leaders](/community/guides/creating-leaders) 🟡
...
- **Target audience**: Modders with basic understanding of game mechanics.
- **Related documents**: [Creating Civilizations](/community/guides/creating-civilizations), [Modding Guide: Civs & Leaders](/community/reference/modding-guide-civs-leaders)

### [Modifying Existing Content](/community/guides/modifying-existing-content) 🟢
...
2. [Modifying Existing Content](/community/guides/modifying-existing-content)
...
5. [Creating Civilizations](/community/guides/creating-civilizations)

### For Content Creators
1. [Mod Patterns](/community/guides/mod-patterns)
2. [Creating Civilizations](/community/guides/creating-civilizations)
3. [Creating Leaders](/community/guides/creating-leaders)
