...
### [Getting Started](/community/guides/getting-started) 🟢
...
- **Related documents**: [Modding Architecture](/community/guides/modding-architecture), [Mod Patterns](/community/guides/mod-patterns)
...
- **Related documents**: [Database Schemas](/community/guides/database-schemas), [Base Standard Module](/community/guides/base-standard-module)
...
- **Related documents**: [Modding Reference](/community/reference/modding-reference)

### [Base Standard Module](/community/guides/base-standard-module) 🟡
...
- **Related documents**: [Age Modules](/community/guides/ages/age-modules)
...
- **Related documents**: [Base Standard Module](/community/guides/base-standard-module), [Age Architecture](/community/guides/ages/age-architecture)

### [Age Architecture](/community/guides/ages/age-architecture) 🟡
...
- **Related documents**: [Age Modules](/community/guides/ages/age-modules), [Age Gameplay Mechanics](/community/guides/ages/age-gameplay-mechanics)

### [Age Gameplay Mechanics](/community/guides/ages/age-gameplay-mechanics) 🟡
...
- **Related documents**: [Age Modules](/community/guides/ages/age-modules), [Gameplay Mechanics](/community/reference/gameplay-mechanics)

### [Mod Patterns](/community/guides/mod-patterns) 🟡
...
- **Related documents**: [Creating Civilizations](/community/guides/general-creating-civilizations), [Creating Leaders](/community/guides/general-creating-leaders)

## Content Creation

### [Creating Civilizations](/community/guides/general-creating-civilizations) 🟡
...
- **Related documents**: [Creating Leaders](/community/guides/general-creating-leaders), [Dacia Implementation Guide](/community/guides/examples/dacia-implementation-guide)

### [Creating Leaders](/community/guides/general-creating-leaders) 🟡
...
- **Target audience**: Modders with basic understanding of game mechanics.
- **Related documents**: [Creating Civilizations](/community/guides/general-creating-civilizations), [Modding Guide: Civs & Leaders](/community/reference/modding-guide-civs-leaders)

### [Modifying Existing Content](/community/guides/general-modifying-content) 🟢
...
- **Related documents**: [TypeScript Modding Tools Technical](/community/guides/typescript/typescript-technical), [Environment Setup](/community/guides/typescript/howto/environment-setup)

### [TypeScript Modding Tools Technical](/community/guides/typescript/typescript-technical) 🔴
...
- **Related documents**: [TypeScript Modding Tools Overview](/community/guides/typescript/typescript-overview)
...
### [Dacia Civilization Ideas](/community/guides/examples/dacia-civilization-ideas) 🟢
...
- **Related documents**: [Dacia Historical Reference](/community/guides/examples/dacia-historical-reference)

### [Dacia Historical Reference](/community/guides/examples/dacia-historical-reference) 🟢
...
- **Related documents**: [Dacia Civilization Ideas](/community/guides/examples/dacia-civilization-ideas)

### [Dacia Implementation Guide](/community/guides/examples/dacia-implementation-guide) 🟡
...
### [Dacia Mechanics Alignment](/community/guides/examples/dacia-mechanics-alignment) 🟡
...
- **Related documents**: [Gameplay Mechanics](/community/reference/gameplay-mechanics)

## Reference Materials

### [File Paths Reference](/community/reference/file-paths-reference) 📊
...
- **Related documents**: [Modding Architecture](/community/guides/modding-architecture)

### [Modding Reference](/community/reference/modding-reference) 📊
...
- **Related documents**: [Database Schemas](/community/guides/database-schemas)

### [Gameplay Mechanics](/community/reference/gameplay-mechanics) 📊
...
- **Related documents**: [Modding Reference](/community/reference/modding-reference), [Age Gameplay Mechanics](/community/guides/ages/age-gameplay-mechanics)

### [Modding Guide: Civs & Leaders](/community/reference/modding-guide-civs-leaders) 📊
...
### For Beginners
1. [Getting Started](/community/guides/getting-started)
2. [Modifying Existing Content](/community/guides/general-modifying-content)
3. [Dacia Civilization Ideas](/community/guides/examples/dacia-civilization-ideas)
4. [Modding Architecture](/community/guides/modding-architecture)
5. [Creating Civilizations](/community/guides/general-creating-civilizations)

### For Content Creators
1. [Mod Patterns](/community/guides/mod-patterns)
2. [Creating Civilizations](/community/guides/general-creating-civilizations)
3. [Creating Leaders](/community/guides/general-creating-leaders)
4. [Dacia Implementation Guide](/community/guides/examples/dacia-implementation-guide)
5. [File Paths Reference](/community/reference/file-paths-reference)

### For TypeScript Modders
1. [TypeScript Modding Tools Overview](/community/guides/typescript/typescript-overview)
2. [Environment Setup](/community/guides/typescript/howto/environment-setup)
3. [Creating Units](/community/guides/typescript/howto/creating-units)
4. [Creating Civilizations](/community/guides/typescript/howto/creating-civilizations)
5. [Advanced Techniques](/community/guides/typescript/howto/advanced-techniques)

### For Technical Modders
1. [Database Schemas](/community/guides/database-schemas)
2. [Base Standard Module](/community/guides/base-standard-module)
3. [TypeScript Modding Tools Technical](/community/guides/typescript/typescript-technical)
4. [Modifiers and Effects](/community/guides/typescript/howto/modifiers-and-effects)
5. [Modding Reference](/community/reference/modding-reference)

## Document Relationship Map

``` text expandable id="community-documentation-guide__76b4c1db" tag="file-tree" wrap
                                      [Getting Started]
                                            │
                      ┌─────────────────────┼─────────────────────┐
                      │                     │                     │
...
``` markdown lines icon="file-lines" id="community-documentation-guide__6017bf88" tag="markdown"
...
- Keep paths relative to the site root so they work with `bun run dev:docs` and per-site servers.
