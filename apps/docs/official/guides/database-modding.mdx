...
``` sql lines icon="database" id="official-guides-database-modding__74034304" tag="sql"
INSERT INTO Types
        (Type,                              Kind)
...
``` sql lines icon="database" id="official-guides-database-modding__002f5737" tag="sql"
...
``` sql lines icon="database" id="official-guides-database-modding__d5821dcf" tag="sql"
