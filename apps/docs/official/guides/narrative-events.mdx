...
> **Important:** 
> This article assumes familiarity with both the basics of [Database Modding](/civ7-official/modding/guides/database-modding) and the [Modifier System](/civ7-official/modding/guides/the-modifier-system). Familiarise yourself with that before diving into modding Narrative Events! And if you have never made a mod before, begin with the [Getting Started](/civ7-official/modding/guides/getting-started) article!
