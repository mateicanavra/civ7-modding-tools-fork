...
You can learn more about how `.modinfo` files are structured in the [modinfo Files](/civ7-official/modding/guides/modinfo-files) article.

But of course, we probably want our mod to *actually do something*. See the [Database Modding](/civ7-official/modding/guides/database-modding) article to learn more.
