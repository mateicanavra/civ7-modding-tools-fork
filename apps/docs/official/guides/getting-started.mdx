...
description: "Introduction to Civ VII modding, file types, and expectations."
---
...
``` xml lines icon="file-xml" id="official-guides-getting-started__269cc8b7" tag="xml"
...
``` sql lines icon="database" id="official-guides-getting-started__e473d263" tag="sql"
INSERT INTO Types
        (Type,                              Kind)
...
While *theoretically* you can make a mod with just Windows Notepad, it'll be easier with the correct tools. 
	<Card title="Code Editor" icon="code" href="https://code.visualstudio.com/" cta="Download Visual Studio Code" arrow="true">
			You'll want a text editor that is geared towards code. **Visual Studio Code** (also known as **VS Code**) is a good option for this.
	</Card>
	
	<Card title="Civilization VII Modding SDK" icon="code" href="https://steamcommunity.com/app/3688890" cta="Download the Modding SDK" arrow="true">
	...
	<Card title="SQLite Database Browser" icon="database" href="https://github.com/beekeeper-studio/beekeeper-studio/" cta="Download SQLite Database Browser" arrow="true">
...
![](/civ7-official/modding/guides/images/SteamProperties.png)

The go the `Installed Files` tab and click `Browse`.
 
![](/civ7-official/modding/guides/images/InstalledFiles.png)
...
![](/civ7-official/modding/guides/images/AppData.png)
...
![](/civ7-official/modding/guides/images/ShowFileExtensions.png)
...
**Before**
``` ini lines icon="file-lines" id="official-guides-getting-started__995d3fb7" tag="ini"
;Make copies of commonly used databases to disk after they have been updated.
;CopyDatabasesToDisk 0
```

**After**
``` ini lines icon="file-lines" id="official-guides-getting-started__e651d7ba" tag="ini"
;Make copies of commonly used databases to disk after they have been updated.
...
![](/civ7-official/modding/guides/images/MyFirstMod.png)

Open the file in a code editor, and copy and paste the following into the file, then save the file.

``` xml lines icon="file-xml" id="official-guides-getting-started__ae05ae22" tag="xml"
<?xml version="1.0" encoding="utf-8"?>
<Mod id="my-first-mod" version="1" xmlns="ModInfo">
	<Properties>
		<Name>My First Mod</Name>
...
![](/civ7-official/modding/guides/images/AddOns.png)
...
You can learn more about how `.modinfo` files are structured in the [modinfo Files](/official/guides/modinfo-files) article.

But of course, we probably want our mod to *actually do something*. See the [Database Modding](/official/guides/database-modding) article to learn more.
