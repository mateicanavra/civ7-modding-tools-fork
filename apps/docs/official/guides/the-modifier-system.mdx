---
title: "The Modifier System"
sidebarTitle: "Modifier System"
description: "How modifiers work and how to assign them to game entities."
---
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__82612763" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__1433343d" tag="sql"
INSERT INTO Types
        (Type,                                      Kind)
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__575afe66" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__2caac0f8" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__1f217481" tag="sql"
INSERT INTO Modifiers
	(
		ModifierId,
		ModifierType,
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__66b52d32" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__d5a037eb" tag="sql"
INSERT INTO Modifiers
	(
		ModifierId,
		ModifierType,
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__818d8597" tag="sql"
...
``` sql lines icon="/icons/icon-code-sql.svg" id="official-guides-the-modifier-system__1f866b03" tag="sql"
...
``` xml lines icon="file-xml" id="official-guides-the-modifier-system__d6b9fc64" tag="xml"
