...
``` sql lines icon="database" id="official-guides-the-modifier-system__82612763" tag="sql"
...
``` sql lines icon="database" id="official-guides-the-modifier-system__1433343d" tag="sql"
INSERT INTO Types
        (Type,                                      Kind)
...
``` sql lines icon="database" id="official-guides-the-modifier-system__575afe66" tag="sql"
...
``` sql lines icon="database" id="official-guides-the-modifier-system__2caac0f8" tag="sql"
...
``` sql lines icon="database" id="official-guides-the-modifier-system__1f217481" tag="sql"
INSERT INTO Modifiers
	(
		ModifierId,
		ModifierType,
...
``` sql lines icon="database" id="official-guides-the-modifier-system__66b52d32" tag="sql"
...
``` sql lines icon="database" id="official-guides-the-modifier-system__d5a037eb" tag="sql"
INSERT INTO Modifiers
	(
		ModifierId,
		ModifierType,
...
``` sql lines icon="database" id="official-guides-the-modifier-system__818d8597" tag="sql"
...
``` sql lines icon="database" id="official-guides-the-modifier-system__1f866b03" tag="sql"
