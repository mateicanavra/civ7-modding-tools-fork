...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__517a4444" tag="xml"
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__49c3c8db" tag="xml"
<Dependencies>
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__6e922d38" tag="xml"
<References>
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__3fa77505" tag="xml"
	<ActionCriteria>
		<Criteria id="antiquity-age-current">
			<AgeInUse>AGE_ANTIQUITY</AgeInUse>
		</Criteria>
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__c1c386af" tag="xml"
	<ConfigurationValueMatches>
		<Group>Game</Group>
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__bc5ccb11" tag="xml"
	<ConfigurationValueContains>
		<Group>Game</Group>
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__f1f839ea" tag="xml"
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__2e46e89b" tag="xml"
	<ActionCriteria>
...
``` xml lines icon="file-xml" id="official-guides-modinfo-files__1ca4072c" tag="xml"
<ActionGroups>
