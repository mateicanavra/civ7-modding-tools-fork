...
1. A basic understanding of the Civilization VII modding architecture (see [Modding Architecture](/migrated/community/guides/guides/modding-architecture))
2. Familiarity with the relevant database schemas (see [Database Schemas](/migrated/community/guides/guides/database-schemas))
3. Knowledge of the Age system (see [Age Modules](/migrated/community/guides/guides/age-modules))
4. The game's base files for reference
5. A working knowledge of creating content (see [General: Creating Civilizations](/migrated/community/guides/guides/general-creating-civilizations) and [General: Creating Leaders](/migrated/community/guides/guides/general-creating-leaders))
...
- [Modding Architecture](/migrated/community/guides/guides/modding-architecture)
- [Database Schemas](/migrated/community/guides/guides/database-schemas)
- [General: Creating Civilizations](/migrated/community/guides/guides/general-creating-civilizations)
- [General: Creating Leaders](/migrated/community/guides/guides/general-creating-leaders)
- [DLC and Community Mod Patterns](/migrated/community/guides/guides/mod-patterns)
