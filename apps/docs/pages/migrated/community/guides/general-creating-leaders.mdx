...
2. Familiarity with the database schema for leaders (see [Database Schemas](/migrated/community/guides/guides/database-schemas))
3. Knowledge of how leaders integrate with civilizations (see [General: Creating Civilizations](/migrated/community/guides/guides/general-creating-civilizations))
