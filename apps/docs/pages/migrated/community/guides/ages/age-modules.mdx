...
- For core architecture concepts, see [Civilization VII Modding Architecture](/migrated/community/guides/ages/guides/modding-architecture)
- For database schema details, see [Database Schemas](/migrated/community/guides/ages/guides/database-schemas)
- For civilization creation guides, see [Creating New Civilizations](/migrated/community/guides/ages/guides/creating-civilizations)
