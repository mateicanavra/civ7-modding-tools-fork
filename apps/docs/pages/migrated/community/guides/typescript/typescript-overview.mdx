...
2. **[Technical Implementation Guide](/migrated/community/guides/typescript/guides/typescript/typescript-technical)** - Details the toolkit's architecture and internal workings
...
For detailed examples of how to create specific elements, see the [How-To Guide](/migrated/community/guides/typescript/guides/typescript/howto/index).
...
- [Modding Architecture Overview](/migrated/community/guides/typescript/guides/modding-architecture)
- [Database Schemas Reference](/migrated/community/guides/typescript/guides/database-schemas)
- [General: Creating New Civilizations](/migrated/community/guides/typescript/guides/general-creating-civilizations)
- [General: Creating New Leaders](/migrated/community/guides/typescript/guides/general-creating-leaders)
- [General: Modifying Existing Content](/migrated/community/guides/typescript/guides/general-modifying-content)
- [TypeScript Technical Implementation](/migrated/community/guides/typescript/guides/typescript/typescript-technical)
- [TypeScript How-To Guides](/migrated/community/guides/typescript/guides/typescript/howto/index) 