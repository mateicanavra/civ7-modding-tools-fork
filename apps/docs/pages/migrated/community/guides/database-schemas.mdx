...
- For implementation guidance, see [Creating New Civilizations](/migrated/community/guides/guides/creating-civilizations)
- For file organization, see [Civilization VII Modding Architecture](/migrated/community/guides/guides/modding-architecture)
- For examples from existing content, see [DLC and Community Mod Patterns](/migrated/community/guides/guides/mod-patterns)
