...
- [Modding Architecture](/migrated/community/guides/guides/modding-architecture): Understand how mods work
- [General: Creating Civilizations](/migrated/community/guides/guides/general-creating-civilizations): Create your first civilization
- [TypeScript Modding Tools](/migrated/community/guides/guides/typescript/typescript-overview): Learn the modding tools in depth

## Further Learning

Once you've completed this guide, consider exploring these resources:

- [Modding Architecture](/migrated/community/guides/guides/modding-architecture): Learn about the architectural components of mods
- [Database Schemas](/migrated/community/guides/guides/database-schemas): Study the database schema for modding
- [General: Creating Civilizations](/migrated/community/guides/guides/general-creating-civilizations): Create your first civilization
- [TypeScript How-To Guides](/migrated/community/guides/guides/typescript/howto/index): Explore the TypeScript modding tools 