...
- The manifest now exposes `foundation` and `landmassPlates` as the default early stages. The legacy Voronoi stub has been removed, so presets and orchestration must target the plate pipeline exclusively.
